...
static void CG_TouchItem(centity_t *cent) {
	...
	// no prediction of books/clipboards
...
void CG_PredictPlayerState(void) {
	...
	if (cg_nopredict.integer || cg_synchronousClients.integer || (cg.snap->ps.eFlags & EF_MG42_ACTIVE)) { // somewhat of a hack, but just disable prediction if on MG42, since it's just not very prediction friendly
