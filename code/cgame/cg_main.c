...
//	{&cg_smoothClients, "cg_smoothClients", "0", CVAR_USERINFO|CVAR_ARCHIVE},
	...
	{&cg_gameSkill, "g_gameskill", "2", 0}, // communicated by systeminfo, new default '2'(was '1') {&cg_reloading, "g_reloading", "0", 0},
...
void CG_UpdateCvars(void) {
	...
	/* NOTE: disabled this, not needed anymore
...
// this is the only thing that sets a cap on #items. would like it to be adaptable (rather than 256 max items with pickup name fixed at 32 chars)
...
static void CG_RegisterGraphics(void) {
	...
	//(I'm certainly not against being efficient here, but I'm tired of the rocket launcher effect only registering sometimes and want it to work for sure for this demo)
...
void CG_QueueMusic(void) {
	...
	// TODO: the values stored in here will be made accessable so it doesn't have to go through startbackgroundtrack() (which is stupid)
...
void CG_Init(int serverMessageNum, int serverCommandSequence) {
	...
	// using Nerve's text since they have foreign characters
