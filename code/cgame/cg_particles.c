...
//		}
	...
	if (!p->pshader) {
		// temp commented out for DM again. FIXME: TODO: this needs to be addressed
...
=======================================================================================================================================
*/
void CG_ParticleDirtBulletDebris_Core(vec3_t org, vec3_t vel, int duration, float width, float height, float alpha, char *shadername) {
...
//	p->roll = crandom() * (float)(maxroll * 2);
	...
	p->width = rand()%4 + radius;
	p->height = rand()%4 + radius;
