...
=======================================================================================================================================
  ...
  SAVE
	...
	12 -
	13 - added 'episode' tracking to savegame
	14 - RF added 'skill'
	15 - moved time info above the main game reading
	16 - added fog
	17 - rats, changed fog
	18 - targetdeath fix
...
#define GENTITYNUM_BITS 11 // don't need to send any more, upped 4/21/2001 adjusted: tr_local.h(802-822), tr_main.c(1501), sv_snapshot(206)
...
typedef struct playerState_s {
	...
	// yeah. this is causing me a little bit of trouble too. can we go ahead with the above suggestion or find an alternative?
	...
	// only once every x (2 minutes) seconds a possible stuck player can use teleport to teleport to another player his spawnpoint
	...
	int venomTime;
	int accShowBits;		// (changed from short), these should all be 32 bit
	int accHideBits;
