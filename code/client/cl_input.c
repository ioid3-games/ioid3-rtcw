...
void CL_FinishMove(usercmd_t *cmd) {
	...
	cmd->holdable = cl.cgameUserHoldableValue;
	cmd->cld = cl.cgameCld;
...
void CL_InitInput(void) {
	...
	Cmd_AddCommand("+salute", IN_Button3Down); // salute
