...
//		Log_Write("shortest distance between %d and %d is %f\r\n", area1num, area2num, bestdist);
		...
		AAS_PredictClientMovement(&move, -1, beststart, PRESENCE_NORMAL, qtrue, velocity, cmdmove, 3, 30, 0.1, SE_HITGROUND|SE_ENTERWATER|SE_ENTERSLIME|SE_ENTERLAVA|SE_HITGROUNDDAMAGE, 0, qfalse);
...
void AAS_SetWeaponJumpAreaFlags(void) {
	...
	for (ent = AAS_NextBSPEntity(0); ent; ent = AAS_NextBSPEntity(ent)) {
		...
		if (!strcmp(classname, "item_armor_body") || !strcmp(classname, "item_armor_combat") || !strcmp(classname, "item_health_mega") ||
			!strcmp(classname, "weapon_grenadelauncher") || !strcmp(classname, "weapon_rocketlauncher") ||
			!strcmp(classname, "weapon_lightning") || !strcmp(classname, "weapon_sp5") || !strcmp(classname, "weapon_railgun") || !strcmp(classname, "weapon_bfg") ||
