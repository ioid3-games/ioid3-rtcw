...
/*
=======================================================================================================================================
AAS_RT_GetValidVisibleAreasCount
...
/*
=======================================================================================================================================
AAS_RT_CalcTravelTimesToGoalArea
=======================================================================================================================================
*/
...
void AAS_RT_BuildRouteTable(void) {
	...
	// to speed things up, build a list of FILTERED areas first do this so we can check for filtered areas
...
//	}
	...
	for (visparents_count = 0, total_parents_checked = 0; visparents_count < MAX_CHECK_VISPARENTS && total_parents_checked < rt->numParents; total_parents_checked++) {
		...
		visparents_count++;
		// they might be visible, check to see if the path to the area, takes us towards the enemy we are trying to hide from
		{
