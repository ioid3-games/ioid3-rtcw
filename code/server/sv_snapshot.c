...
=======================================================================================================================================
*/
static void SV_AddEntitiesVisibleFromPoint(vec3_t origin, clientSnapshot_t *frame, snapshotEntityNumbers_t *eNums, qboolean portal, qboolean localClient) {
	int e, i;
	...
	for (e = 0; e < sv.num_entities; e++) {
		...
		// 1 = counts AI's so they're hidden as well, 2 only hides players so normal WH will still show AI thru wall but hide players(theoretically).
		wh = ((awh_active->integer == 1) ? sv_maxclients->integer : sv_maxcoopclients->integer);
