...
void QDECL SV_SendServerCommand(client_t *cl, const char *fmt, ...) {
	...
	va_end(argptr);
	// do not forward server command messages that would be too big to clients (q3infoboom/q3msgboom stuff)
...
void SVC_Info(netadr_t from) {
	...
	Info_SetValueForKey(infostring, "sv_maxclients", va("%i", maxclients - sv_privateClients->integer));
...
Responds with a short info message that tells the client if they have an update available for their version.
=======================================================================================================================================
*/
