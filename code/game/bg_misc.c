...
ammotable_t ammoTable[] = {
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	{                 0,                      0,                       0,                       0,                     50,                     0,                      0,                      0,                     0}, //  0 - WP_NONE
	{               999,                      0,                     999,                       0,                     50,                   200,                      0,                      0,             MOD_KNIFE}, //  1 - WP_KNIFE
	{      MAX_AMMO_9MM,                      1,                       8,                    1500,           DELAY_PISTOL,                   400,                      0,                      0,             MOD_LUGER}, //  2 - WP_LUGER  --  NOTE: also 32 round 'snail' magazine
	{      MAX_AMMO_9MM,                      1,                      32,                    2600,              DELAY_LOW,                   100,                      0,                      0,              MOD_MP40}, //  3 - WP_MP40
	{   MAX_AMMO_MAUSER,                      1,                      10,                    2500,             DELAY_HIGH,                  1200,                      0,                      0,            MOD_MAUSER}, //  4 - WP_MAUSER  --  NOTE: authentic clips are 5/10/25 rounds
	{     MAX_AMMO_FG42,                      1,                      20,                    2000,              DELAY_LOW,                   200,                      0,                      0,              MOD_FG42}, //  5 - WP_FG42
	{                15,                      1,                      15,                    1000,            DELAY_THROW,                  1600,                      0,                      0,  MOD_GRENADE_LAUNCHER}, //  6 - WP_GRENADE_LAUNCHER
	{                 5,                      1,                       1,                    1000,         DELAY_SHOULDER,                  2000,                      0,                      0,       MOD_PANZERFAUST}, //  7 - WP_PANZERFAUST
//	{    MAX_AMMO_VENOM,                      1,                     500,                    3000,                    750,                    30,                   5000,                    200,             MOD_VENOM}, //  - - WP_VENOM
	{    MAX_AMMO_VENOM,                      1,                     500,                    3000,                    750,                    45,                   5000,                    200,             MOD_VENOM}, //  8 - WP_VENOM  --  NOTE: changed next_shot 50 -> 45 to genlock firing to every server frame (fire rate shouldn't be framerate dependent now)
	{               150,                      1,                     150,                    1000,              DELAY_LOW,                    50,                      0,                      0,      MOD_FLAMETHROWER}, //  9 - WP_FLAMETHROWER
	{               300,                      1,                     300,                    1000,              DELAY_LOW,                     0,                      0,                      0,             MOD_TESLA}, // 10 - WP_TESLA
//	{                50,                      1,                      50,                    1000,              DELAY_LOW,                  1200,                      0,                      0,          MOD_SPEARGUN}, // 11 - WP_SPEARGUN
//	{               999,                      0,                     999,                       0,                     50,                   200,                      0,                      0,            MOD_KNIFE2}, // 12 - WP_KNIFE2
	{       MAX_AMMO_45,                      1,                       8,                    1500,           DELAY_PISTOL,                   400,                      0,                      0,              MOD_COLT}, // 13 - WP_COLT
	{       MAX_AMMO_45,                      1,                      30,                    2400,              DELAY_LOW,                   120,                      0,                      0,          MOD_THOMPSON}, // 14 - WP_THOMPSON  --  NOTE: also 50 round drum magazine
	{   MAX_AMMO_GARAND,                      1,                       5,                    2500,             DELAY_HIGH,                  1200,                      0,                      0,            MOD_GARAND}, // 15 - WP_GARAND  --  NOTE: always 5 round clips
//	{      MAX_AMMO_BAR,                      1,                      20,                    2000,              DELAY_LOW,                   200,                      0,                      0,               MOD_BAR}, // 16 - WP_BAR
	{                15,                      1,                      15,                    1000,            DELAY_THROW,                  1600,                      0,                      0, MOD_GRENADE_PINEAPPLE}, // 17 - WP_GRENADE_PINEAPPLE
//	{                 5,                      1,                       5,                    1000,         DELAY_SHOULDER,                  1200,                      0,                      0,   MOD_ROCKET_LAUNCHER}, // 18 - WP_ROCKET_LAUNCHER
	{   MAX_AMMO_MAUSER,                      1,                      10,                    3000,                      0,                  1700,                      0,                      0,       MOD_SNIPERRIFLE}, // 19 - WP_SNIPER_GER
	{   MAX_AMMO_GARAND,                      1,                       5,                    3000,                      0,                  1200,                      0,                      0,      MOD_SNOOPERSCOPE}, // 20 - WP_SNIPER_AM
//	{    MAX_AMMO_VENOM,                     10,                     300,                    3000,                   1200,                  1200,                      0,                      0,        MOD_VENOM_FULL}, //  - - WP_VENOM_FULL
//	{    MAX_AMMO_VENOM,                     10,                     300,                    3000,                   1000,                  1000,                      0,                      0,        MOD_VENOM_FULL}, // 21 - WP_VENOM_FULL
//	{                20,                      1,                      20,                    1000,              DELAY_LOW,                  1200,                      0,                      0,      MOD_SPEARGUN_CO2}, // 22 - WP_SPEARGUN_CO2
	{     MAX_AMMO_FG42,                      1,                      20,                    2000,              DELAY_LOW,                   200,                      0,                      0,         MOD_FG42SCOPE}, // 23 - WP_FG42SCOPE
//	{      MAX_AMMO_BAR,                      1,                      20,                    2000,              DELAY_LOW,                    90,                      0,                      0,               MOD_BAR}, // 24 - WP_BAR2
	{      MAX_AMMO_9MM,                      1,                      32,                    3100,              DELAY_LOW,                   110,                      700,                  300,              MOD_STEN}, // 25 - WP_STEN
	{      MAX_AMMO_9MM,                      1,                       8,                    1500,           DELAY_PISTOL,                   400,                      0,                      0,          MOD_SILENCER}, // 26 - WP_SILENCER
	{       MAX_AMMO_45,                      1,                       8,                    2700,           DELAY_PISTOL,                   200,                      0,                      0,            MOD_AKIMBO}, // 27 - WP_AKIMBO
	{               999,                      0,                     999,                       0,                     50,                     0,                      0,                      0,                     0}, // 28 - WP_CLASS_SPECIAL (class_special)
//	{               100,                      1,                     100,                    1000,           DELAY_PISTOL,                   900,                      0,                      0,             MOD_CROSS}, // 29 - WP_CROSS
	{                10,                      1,                      10,                    1000,            DELAY_THROW,                  1600,                      0,                      0,          MOD_DYNAMITE}, // 30 - WP_DYNAMITE
//	{                10,                      1,                      10,                    1000,            DELAY_THROW,                  1600,                      0,                      0,          MOD_DYNAMITE}, // 31 - WP_DYNAMITE2
	// stubs for some "not-real" weapons (so they always return "yes, you have enough ammo for that gauntlet", etc.)
//	{                 5,                      1,                       5,                    1000,         DELAY_SHOULDER,                  1200,                      0,                      0,                     0}, // 32 - WP_PROX
	{               999,                      0,                     999,                       0,                     50,                     0,                      0,                      0,                     0}, // 33 - WP_MONSTER_ATTACK1
	{               999,                      0,                     999,                       0,                     50,                     0,                      0,                      0,                     0}, // 34 - WP_MONSTER_ATTACK2
	{               999,                      0,                     999,                       0,                     50,                     0,                      0,                      0,                     0}, // 35 - WP_MONSTER_ATTACK3
	{               999,                      0,                     999,                       0,                     50,                     0,                      0,                      0,                     0}  // 36 - WP_GAUNTLET
};
...
//	WP_NONE,			// 29 WP_CROSS
	WP_NONE				// 30 WP_DYNAMITE (not in rotation yet)
//	WP_DYNAMITE			// 31 WP_DYNAMITE2
};
...
// the addition of the 'ammotype' field was added by me, not removed by id
gitem_t bg_itemlist[] = {
	{
		NULL,
		NULL,
...
*/
	{
		"weapon_knife",
		"sound/misc/w_pkup.wav",
		{"models/multiplayer/knife/knife.md3", "models/multiplayer/knife/v_knife.md3", 0, "models/multiplayer/knife/v_knife_axis.md3", 0},
...
/*
	{
		"weapon_knife2",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/knife2/knife2.md3", "models/weapons2/knife2/v_knife2.md3", "models/weapons2/knife2/pu_knife2.md3", 0, 0},
...
*/
	{
		"weapon_luger",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/luger/luger.md3", "models/weapons2/luger/v_luger.md3", 0, 0, "models/weapons2/luger/ss_luger.md3"},
...
/*
	{
		"weapon_bar",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/bar/bar.md3", "models/weapons2/bar/v_bar.md3", "models/weapons2/bar/pu_bar.md3", 0, 0},
...
*/
	{
		"weapon_silencer",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/silencer/silencer.md3", // changed 10/25
...
/*
	{
		...
		"sound/misc/w_pkup.wav",
		{"models/weapons2/rocketl/rocketl.md3", "models/weapons2/rocketl/v_rocketl.md3", "models/weapons2/rocketl/pu_rocketl.md3", 0, 0},
...
/*{
		"weapon_grenadesmoke",
		"sound/misc/w_pkup.wav",
		{"models/multiplayer/smokegrenade/smokegrenade.md3", "models/multiplayer/smokegrenade/v_smokegrenade.md3", "models/multiplayer/smokegrenade/pu_smokegrenade.md3", 0, 0},
...
/*	{
		"weapon_medic_heal",
		"sound/misc/w_pkup.wav",
		{"models/multiplayer/medpack/medpack.md3", "models/multiplayer/medpack/v_medpack.md3", "models/multiplayer/medpack/pu_medpack.md3", 0, 0},
...
/*
	{
		"weapon_cross",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/cross/cross.md3", "models/weapons2/cross/v_cross.md3", "models/weapons2/cross/pu_cross.md3", 0, 0},
...
/*
	{
		"weapon_speargun",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/speargun/speargun.md3", "models/weapons2/speargun/v_speargun.md3", "models/weapons2/speargun/pu_speargun.md3", 0, 0},
...
*/
	{
		"weapon_sniperScope",
		"sound/misc/w_pkup.wav",
		{"models/weapons2/mauser/mauser.md3", "models/weapons2/mauser/v_mauser.md3", "models/weapons2/mauser/pu_mauser_scope.md3", 0, 0},
		"icons/iconw_mauser_1", // icon
		"icons/ammo10", // ammo icon
		"Sniper Scope", // pickup
		200,
...
/*
	{
		...
		"sound/misc/w_pkup.wav",
		{"models/multiplayer/hammer/hammer.md3", "models/multiplayer/hammer/v_hammer.md3", "models/multiplayer/hammer/pu_hammer.md3", 0, 0,},
...
/*
	{
		"ammo_speargun",
		"sound/misc/am_pkup.wav",
		{"models/powerups/ammo/amspear.md3", 0, 0, 0, 0},
...
/*
	{
		"ammo_rockets",
		"sound/misc/am_pkup.wav",
		{"models/powerups/ammo/amrocket.md3", 0, 0, 0, 0},
...
/*
	{
		"ammo_charges",
		"sound/misc/am_pkup.wav",
		{"models/powerups/ammo/amcharges.md3", 0, 0, 0, 0},
...
// hopefully it doesn't need to be a quaked thing. apologies if it does and I'll put it back.
/*
...
/*
	{
		...
		{"models/powerups/holdable/skull.md3", 0, 0, 0, 0},
		"icons/skull", // icon
		NULL, // ammo icon
...
/*
	{
		...
		{"models/powerups/holdable/water.md3",0, 0, 0, 0},
		"icons/water", // icon
		NULL, // ammo icon
		"Breather", // pickup
		1,
...
/*
	{
		...
		{"models/powerups/holdable/elec.md3", 0, 0, 0, 0},
		"icons/elec", // icon
		NULL, // ammo icon
...
/*
	{
		...
		{"models/powerups/holdable/fire.md3", 0, 0, 0, 0},
		"icons/fire", // icon
		NULL, // ammo icon
...
/*
	{
		...
		{"models/powerups/holdable/11.md3", 0, 0, 0, 0},
		"icons/11", // icon
		NULL, // ammo icon
		"11", // pickup
		1,
...
/*
	{
		...
		{"models/powerups/holdable/12.md3", 0, 0, 0, 0},
		"icons/12",// icon
		NULL,// ammo icon
		"12",// pickup
		1,
...
/*
	{
		...
		{"models/powerups/holdable/13.md3", 0, 0, 0, 0},
		"icons/13", // icon
		NULL, // ammo icon
		"13", // pickup
		1,
...
/*
	{
		...
		{"models/powerups/holdable/14.md3", 0, 0, 0, 0},
		"icons/14", // icon
		NULL, // ammo icon
		"14", // pickup
		1,
...
/
	{
		...
		{"models/powerups/holdable/15.md3", 0, 0, 0, 0},
		"icons/15", // icon
		NULL, // ammo icon
		"15", // pickup
		1,
...
/*
	{
		...
		{"models/powerups/keys/skull.md3", 0, 0, 0, 0},
...
/*
	{
		...
		{"models/powerups/keys/chalice.md3", 0, 0, 0, 0},
...
/*
	{
		...
		{"models/powerups/keys/eye.md3", 0, 0, 0, 0},
...
/*
	{
		...
		{"models/powerups/keys/radio_port.md3", 0, 0, 0, 0},
...
/*
	{
		...
		{"models/powerups/keys/satchel_charge.md3", 0, 0, 0, 0},
...
/*
	{
		...
		{"models/powerups/keys/key7.md3", 0, 0, 0, 0},
		"icons/key7", // icon
		NULL, // ammo icon
		"Key 7", // pickup
		0,
...
/*
	{
		...
		{"models/powerups/keys/key.md3", 0, 0, 0, 0},
		"icons/key8", // icon
		NULL, // ammo icon
		"Key 8", // pickup
		0,
...
qboolean BG_PlayerSeesItem(playerState_t *ps, entityState_t *item, int atTime) {
	...
	// ít would be nice if the angle vectors for the player have already been figured at this point and I can just pick them up (if anybody is storing this somewhere, for the current frame please let me know so I don't have to do redundant calcs)
	...
	switch (item->giType) {
		...
		case IT_TEAM: // team items, such as flags
			...
			if (ps->persistant[PERS_TEAM] == TEAM_RED) {
				if (item->giTag == PW_BLUEFLAG || (item->giTag == PW_REDFLAG && ent->otherEntityNum2) || (item->giTag == PW_REDFLAG && ps->powerups[PW_BLUEFLAG])) {
					return qtrue;
				}
			} else if (ps->persistant[PERS_TEAM] == TEAM_BLUE) {
				if (item->giTag == PW_REDFLAG || (item->giTag == PW_BLUEFLAG && ent->otherEntityNum2) || (item->giTag == PW_BLUEFLAG && ps->powerups[PW_REDFLAG])) {
					return qtrue;
				}
			}
...
Used to find a good directional vector for a mark projection, which will be more likely to wrap around adjacent surfaces.
...
char *eventnames[] = {
	...
	"EV_SPINUP",				// panzerfaust preamble for MP balance
	"EV_SNOW_ON",
	"EV_SNOW_OFF",
...
void BG_PlayerStateToEntityState(playerState_t *ps, entityState_t *s, qboolean snap) {
	...
	// let clients know if this person is using a mounted weapon so they don't show any client muzzle flashes
	// moved up since it needs to set the ps->eFlags too. Seems like this could be the problem Raf was encountering with the EF_DEAD flag below when guys
	...
	// now using a circular list of events for all entities add any new events that have been added to the playerState_t (possibly overwriting entityState_t events)
...
void BG_PlayerStateToEntityStateExtraPolate(playerState_t *ps, entityState_t *s, int time, qboolean snap) {
	...
	// add any new events that have been added to the playerState_t (possibly overwriting entityState_t events)
