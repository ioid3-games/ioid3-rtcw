...
void G_RunMover(gentity_t *ent) {
	...
	if (ent->flags & FL_TEAMSLAVE) {
		// FIXME
		// hack to fix problem of tram car slaves being linked after being unlinked in G_FindTeams
...
Determine if there is an entity pointing at ent that is not a "trigger_aidoor" (used now for checking which key to set for a door).
=======================================================================================================================================
*/
...
//---- (SA)	end
	...
	if (!(ent->flags & FL_TEAMSLAVE)) {
		...
		// is this safe? is ent->spawnflags & 8 consistant among all keyed ents?
		...
		// slaves have been marked as FL_TEAMSLAVE now, so they won't finish their think on their own. So set keys for teamed doors
		for (slave = ent; slave; slave = slave->teamchain) {
			if (slave == ent) {
				continue;
			}
...
Positions have been swapped. This swaps the sounds around as well.
=======================================================================================================================================
*/
...
Get sound indexes for the various door sounds (used by SP_func_door()and SP_func_door_rotating()).
=======================================================================================================================================
*/
...
Seemed better to have this isolated. this way i can get func_invisible_user's using the regular rules of doors.
=======================================================================================================================================
*/
