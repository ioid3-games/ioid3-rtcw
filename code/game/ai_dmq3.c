...
void BotChooseWeapon(bot_state_t *bs) {
	...
	if (bs->cur_ps.weaponstate == WEAPON_RAISING || bs->cur_ps.weaponstate == WEAPON_RAISING_TORELOAD || bs->cur_ps.weaponstate == WEAPON_DROPPING || bs->cur_ps.weaponstate == WEAPON_DROPPING_TORELOAD) {
...
void BotCheckAttack(bot_state_t *bs) {
	...
	BotAI_Trace(&trace, start, mins, maxs, end, bs->entitynum, MASK_SHOT); // should this maybe check the weapon type and adjust the clipflag?  it seems like this is probably fine as-is, but I thought I'd note it.
