...
struct gclient_s {
	...
	int sniperRifleFiredTime;	// last time a sniper rifle was fired(for muzzle flip effects)
	float sniperRifleMuzzleYaw;	// for time-dependent muzzle flip in multiplayer
...
typedef struct {
	...
	// maybe not the best place to add this
...
// removed unused q3a weapon firing
...
//---- commented out as we have no hook
