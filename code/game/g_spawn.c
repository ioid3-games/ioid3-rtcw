...
field_t fields[] = {
	...
	{"popup", FOFS(message), F_STRING}, // mutually exclusive from 'message', but makes the ent more logical for the level designer
	{"book", FOFS(message), F_STRING}, // mutually exclusive from 'message', but makes the ent more logical for the level designer
...
spawn_t spawns[] = {
	...
	{"coop_spawnpoint_trigger", SP_coop_spawnpoint_trigger},
...
void SP_worldspawn(void) {
	...
	// FIXME: sun shader set for worldspawn
