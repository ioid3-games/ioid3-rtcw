...
int openMenuCount = 0;
// a stack for modal menus only, stores the menus to come back to (an item can be NULL, goes back to main menu/no action required)
...
// removed code that made me nervous and didn't do anything.(10/11/01)
