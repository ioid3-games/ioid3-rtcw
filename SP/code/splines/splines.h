...
enum positionType {
	FIXED = 0x00, INTERPOLATED, SPLINE, POSITION_COUNT
};
...
virtual void startEdit() {    // DAJ added void 	editMode = true;
}

virtual void stopEdit() {     // DAJ added void 	editMode = false;
}
