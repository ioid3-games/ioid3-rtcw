...
static weaponType_t weaponTypes[] = {
	...
	{WP_COLT, "1911 pistol", PT_PISTOL, "mp_weapon", 0, "ui/assets/weapon_colt1911.tga", "firing_pistolB_1", "stand_pistolB"}, {WP_LUGER, "Luger pistol", PT_PISTOL, "mp_weapon", 1, "ui/assets/weapon_luger.tga", "firing_pistolB_1", "stand_pistolB"}, // 	{0, "Medkit", PT_MEDKIT, "mp_item2", 2, "ui/assets/item_medkit.tga", "firing_pistolB_1", "stand_pistolB"},
	{WP_MP40,  "MP40 submachinegun", PT_LIGHTONLY|PT_RIFLE, "mp_weapon", 3, "ui/assets/weapon_mp40.tga", "relaxed_idle_2h_1", "relaxed_idle_2h_1"}, {WP_THOMPSON, "Thompson submachinegun", PT_LIGHTONLY|PT_RIFLE, "mp_weapon", 4, "ui/assets/weapon_thompson.tga", "relaxed_idle_2h_1", "relaxed_idle_2h_1"}, {WP_STEN,  "Sten submachinegun", PT_LIGHTONLY|PT_RIFLE, "mp_weapon", 5, "ui/assets/weapon_sten.tga", "relaxed_idle_2h_1", "relaxed_idle_2h_1"},
	{WP_MAUSER, "Mauser sniper rifle", PT_RIFLE, "mp_weapon", 6, "ui/assets/weapon_mauser.tga", "stand_rifle", "stand_rifle"}, {WP_GARAND, "Garand rifle",  PT_RIFLE, "mp_weapon", 7, "ui/assets/weapon_mauser.tga", "stand_rifle", "stand_rifle"}, {WP_PANZERFAUST, "Panzerfaust",   PT_RIFLE, "mp_weapon", 8, "ui/assets/weapon_panzerfaust.tga", "stand_machinegun", "stand_machinegun"}, {WP_VENOM, "Minigun", PT_RIFLE, "mp_weapon", 9, "ui/assets/weapon_venom.tga", "stand_machinegun", "stand_machinegun"}, {WP_FLAMETHROWER, "Flamethrower",  PT_RIFLE, "mp_weapon", 10, "ui/assets/weapon_flamethrower.tga", "stand_machinegun", "stand_machinegun"},
	{WP_GRENADE_PINEAPPLE, "Pineapple grenade", PT_GRENADES, "mp_item1", 11, "ui/assets/weapon_grenade.tga", "firing_pistolB_1", "stand_pistolB"}, {WP_GRENADE_LAUNCHER, "Stick grenade", PT_GRENADES, "mp_item1", 12, "ui/assets/weapon_grenade_ger.tga", "firing_pistolB_1", "stand_pistolB"},
...
static uiitemType_t itemTypes[] = {
	{UI_KNIFE_PIC, PT_KNIFE, "ui/assets/weapon_knife.tga"}, {UI_PISTOL_PIC, PT_PISTOL, "ui/assets/weapon_colt1911.tga"},
	{UI_WEAPON_PIC, PT_RIFLE, "ui/assets/weapon_mauser.tga"},
	{UI_ITEM1_PIC, PT_MEDKIT, "ui/assets/item_medkit.tga"},
	{UI_ITEM1_PIC, PT_GRENADES, "ui/assets/weapon_grenade.tga"}, {UI_ITEM2_PIC, PT_EXPLOSIVES, "ui/assets/weapon_dynamite.tga"},
	{NULL, 0, NULL}
};
...
static void UI_Update(const char *name) {
	...
	if (Q_stricmp(name, "ui_SetName") == 0) {
		...
		case 1: // normal
			...
			trap_Cvar_SetValue("r_inGameVideo", 1);
			trap_Cvar_SetValue("cg_brassTime", 2500);
			trap_Cvar_Set("r_texturemode", "GL_LINEAR_MIPMAP_NEAREST"); // modified so wolf never sets trilinear automatically
...
static void UI_RunMenuScript(char **args) {
	...
	if (String_Parse(args, &name)) {
		//#ifdef MISSIONPACK			// enabled for multiplayer
...
static void UI_BuildServerDisplayList(int force) {
	...
	for (i = 0; i < count; i++) {
		...
		if (ping > 0 || ui_netSource.integer == UIAS_FAVORITES) {
			...
			/*	// comment out for now, not recognizing "gametype" properly
		...
		if (index >= 0 && index < uiInfo.serverStatus.numDisplayServers) {
			...
			case SORT_HOST:
				if (ping <= 0) {
					...
					Com_sprintf(hostname, sizeof(hostname), "^7| ^ 2%s ^ 7|  %s", netnames[nettype], Info_ValueForKey(info, "hostname"));
					return hostname;
				}
...
static int UI_OwnerDraw_Width(int ownerDraw) {
 // TTimo: end of non - void return 0;
}
*/
...
void _UI_Init(qboolean inGameLoad) {
	...
	uiInfo.uiDC.getTranslatedString = &UI_translateString;
...
#else {&ui_menuFiles, "ui_menuFiles", "ui/menus.txt", CVAR_ARCHIVE},
#endif
...
// 	{&ui_headModel, "headModel", "", 0},
	...
	{&ui_limboMode, "ui_limboMode", "0", 0}, // - NERVE - SMF
