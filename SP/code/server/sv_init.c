...
void SV_ChangeMaxClients(void) {
	...
	// free reliable commands for clients outside the NEW maxclients limit
	...
	// allocate reliable commands for newly created client slots
	if (oldMaxClients < sv_maxclients->integer) {
		if (sv_gametype->integer == GT_SINGLE_PLAYER) {
...
void SV_SpawnServer(char *server, qboolean killBots) {
	...
	const char *p;
	// enforce maxclients in single player, so there is enough room for AI characters
	{
