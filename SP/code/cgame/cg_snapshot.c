...
static void CG_ResetEntity(centity_t *cent) {
	...
	// disabled this, since we clear events out now in g_main.c, this is redundant, and actually
...
static snapshot_t *CG_ReadNextSnapshot(void) {
	...
	while (cgs.processedSnapshotNum < cg.latestSnapshotNum) {
		...
		if (r) {
			...
			// if we have no weapon selected, and this snapshots says we have a weapon, then switch to that
