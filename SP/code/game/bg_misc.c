...
RTCW SP source code is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as
published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.

RTCW SP source code is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.

You should have received a copy of the GNU General Public License along with RTCW SP source code; if not,
see <http://www.gnu.org/licenses/>.

In addition, the RTCW SP source code is also subject to certain additional terms. You should have received a copy of these additional
terms immediately following the terms and conditions of the GNU General Public License which accompanied the RTCW SP source code.
If not, please request a copy in writing from id Software at the address below.

If you have questions concerning this license or the applicable additional terms, you may contact in writing id Software LLC,
...
// {	MAX_AMMO_VENOM, 1, 500, 3000, 750, 30, 5000, 200, MOD_VENOM				}, // WP_VENOM				// - 
	{  MAX_AMMO_VENOM, 1, 500, 3000, 750, 45, 5000, 200, MOD_VENOM            }, // WP_VENOM				// 8	// JPW NOTE: changed next_shot 50->45 to genlock firing to every server frame(fire rate shouldn't be framerate dependent now) {  150, 1, 150, 1000, DELAY_LOW, 50, 0, 0, MOD_FLAMETHROWER     }, // WP_FLAMETHROWER			// 9
...
// WP_BAR, // 24 WP_BAR2		// new
	WP_NONE, // 25 WP_STEN
	WP_LUGER, // 26 WP_SILENCER	// was sp5
	WP_COLT, // 27 WP_AKIMBO		// new
	WP_NONE, // 28 WP_CLASS_SPECIAL
// WP_NONE, // 29 WP_CROSS
	WP_NONE            // 30 WP_DYNAMITE	// modified(not in rotation yet)
// WP_DYNAMITE			// 31 WP_DYNAMITE2	// new
};


// new(10 / 18 / 00)
char *animStrings[] = {
	"BOTH_DEATH1", "BOTH_DEAD1", "BOTH_DEAD1_WATER", "BOTH_DEATH2", "BOTH_DEAD2", "BOTH_DEAD2_WATER", "BOTH_DEATH3", "BOTH_DEAD3", "BOTH_DEAD3_WATER",

	"BOTH_CLIMB", "BOTH_CLIMB_DOWN", "BOTH_CLIMB_DISMOUNT",

	"BOTH_SALUTE",

	"BOTH_PAIN1", "BOTH_PAIN2", "BOTH_PAIN3", "BOTH_PAIN4", "BOTH_PAIN5", "BOTH_PAIN6", "BOTH_PAIN7", "BOTH_PAIN8",

	"BOTH_GRAB_GRENADE",

	"BOTH_ATTACK1", "BOTH_ATTACK2", "BOTH_ATTACK3", "BOTH_ATTACK4", "BOTH_ATTACK5",

	"BOTH_EXTRA1", "BOTH_EXTRA2", "BOTH_EXTRA3", "BOTH_EXTRA4", "BOTH_EXTRA5", "BOTH_EXTRA6", "BOTH_EXTRA7", "BOTH_EXTRA8", "BOTH_EXTRA9", "BOTH_EXTRA10", "BOTH_EXTRA11", "BOTH_EXTRA12", "BOTH_EXTRA13", "BOTH_EXTRA14", "BOTH_EXTRA15", "BOTH_EXTRA16", "BOTH_EXTRA17", "BOTH_EXTRA18", "BOTH_EXTRA19", "BOTH_EXTRA20",

	"TORSO_GESTURE", "TORSO_GESTURE2", "TORSO_GESTURE3", "TORSO_GESTURE4",

	"TORSO_DROP",

	"TORSO_RAISE", // (low)
	"TORSO_ATTACK", "TORSO_STAND", "TORSO_STAND_ALT1", "TORSO_STAND_ALT2", "TORSO_READY", "TORSO_RELAX",

	"TORSO_RAISE2", // (high)
	"TORSO_ATTACK2", "TORSO_STAND2", "TORSO_STAND2_ALT1", "TORSO_STAND2_ALT2", "TORSO_READY2", "TORSO_RELAX2",

	"TORSO_RAISE3", // (pistol)
	"TORSO_ATTACK3", "TORSO_STAND3", "TORSO_STAND3_ALT1", "TORSO_STAND3_ALT2", "TORSO_READY3", "TORSO_RELAX3",

	"TORSO_RAISE4", // (shoulder)
	"TORSO_ATTACK4", "TORSO_STAND4", "TORSO_STAND4_ALT1", "TORSO_STAND4_ALT2", "TORSO_READY4", "TORSO_RELAX4",

	"TORSO_RAISE5", // (throw)
	"TORSO_ATTACK5", "TORSO_ATTACK5B", "TORSO_STAND5", "TORSO_STAND5_ALT1", "TORSO_STAND5_ALT2", "TORSO_READY5", "TORSO_RELAX5",
	...
	"TORSO_EXTRA", "TORSO_EXTRA2", "TORSO_EXTRA3", "TORSO_EXTRA4", "TORSO_EXTRA5", "TORSO_EXTRA6", "TORSO_EXTRA7", "TORSO_EXTRA8", "TORSO_EXTRA9", "TORSO_EXTRA10",

	"LEGS_WALKCR", "LEGS_WALKCR_BACK", "LEGS_WALK", "LEGS_RUN", "LEGS_BACK", "LEGS_SWIM", "LEGS_SWIM_IDLE",

	"LEGS_JUMP", "LEGS_JUMPB", "LEGS_LAND",

	"LEGS_IDLE", "LEGS_IDLE_ALT", // "LEGS_IDLE2"
	"LEGS_IDLECR",
	...
	"LEGS_EXTRA1", "LEGS_EXTRA2", "LEGS_EXTRA3", "LEGS_EXTRA4", "LEGS_EXTRA5", "LEGS_EXTRA6", "LEGS_EXTRA7", "LEGS_EXTRA8", "LEGS_EXTRA9", "LEGS_EXTRA10",
};
...
char *animStringsOld[] = {
	...
	"BOTH_EXTRA1", "BOTH_EXTRA2", "BOTH_EXTRA3", "BOTH_EXTRA4", "BOTH_EXTRA5",
	...
	"TORSO_RAISE", // (low)
	"TORSO_ATTACK", "TORSO_STAND", "TORSO_READY", "TORSO_RELAX",

	"TORSO_RAISE2", // (high)
	"TORSO_ATTACK2", "TORSO_STAND2", "TORSO_READY2", "TORSO_RELAX2",

	"TORSO_RAISE3", // (pistol)
	"TORSO_ATTACK3", "TORSO_STAND3", "TORSO_READY3", "TORSO_RELAX3",

	"TORSO_RAISE4", // (shoulder)
	"TORSO_ATTACK4", "TORSO_STAND4", "TORSO_READY4", "TORSO_RELAX4",

	"TORSO_RAISE5", // (throw)
	"TORSO_ATTACK5", "TORSO_ATTACK5B", "TORSO_STAND5", "TORSO_READY5", "TORSO_RELAX5",
	...
	"TORSO_EXTRA2", "TORSO_EXTRA3", "TORSO_EXTRA4", "TORSO_EXTRA5",

	"LEGS_WALKCR", "LEGS_WALKCR_BACK", "LEGS_WALK", "LEGS_RUN", "LEGS_BACK", "LEGS_SWIM",
	...
	"LEGS_EXTRA1", "LEGS_EXTRA2", "LEGS_EXTRA3", "LEGS_EXTRA4", "LEGS_EXTRA5",
};
...
gitem_t bg_itemlist[] = {
	{
		NULL, NULL, {NULL, NULL, 0, 0, 0}, NULL, // icon
		NULL, // ammo icon
		NULL, // pickup
		0, 0, 0, 0, // ammotype
		0, // cliptype
...
*/
	{
		"item_clipboard", "sound / pickup / armor/body_pickup.wav", {  "models/powerups/clipboard / clipboard.md3", 0, 0, 0, 0}, "icons/iconh_small", NULL,   // ammo icon
		"", 1, IT_CLIPBOARD, 0, 0, 0, "", "", {0, 0, 0, 0}
	}, 
...
*/
	{
		"item_treasure", "sound / pickup / treasure / gold.wav", {  "models/powerups/treasure / goldbar.md3", 0, 0, 0, 0}, "icons/iconh_small", // (SA) placeholder
		NULL,   // ammo icon
		"Treasure Item", // (SA) placeholder
		5, IT_TREASURE, 0, 0, 0, "", "", {0, 0, 0, 0}
	}, 
...
*/
	{
		"item_health_small", "sound / pickup / health/health_pickup.wav", {  "models/powerups/health/health_s.md3", 0, 0, 0, 0}, "icons/iconh_small", NULL, // ammo icon
		"Small Health", 5, IT_HEALTH, 0, 0, 0, "", "", {10, 10, 5, 5}
	}, 
...
*/
	{
		"item_health", "sound / pickup / health/health_pickup.wav", {  "models/powerups/health/health_m.md3", 0, 0, 0, 0}, "icons/iconh_med", NULL, // ammo icon
		"Med Health", 25, IT_HEALTH, 0, 0, 0, "", "", {25, 25, 15, 15}
	}, 
...
*/
	{
		"item_health_large", "sound / pickup / health/health_pickup.wav", {  "models/powerups/health/health_l.md3", 0, 0, 0, 0}, "icons/iconh_large", NULL, // ammo icon
		"Large Health", 50, IT_HEALTH, 0, 0, 0, "", "", {50, 50, 30, 20}
	}, 
...
*/
	{
		"item_health_turkey", "sound / pickup / health/hot_pickup.wav", {  "models/powerups/health/health_t3.md3", // just plate(should now be destructable)
 "models/powerups/health/health_t2.md3", // half eaten
 "models/powerups/health/health_t1.md3", // whole turkey
			0, 0}, "icons/iconh_turkey", NULL, // ammo icon
		"Hot Meal", 15, // amount given in last stage
		IT_HEALTH, 0, 0, 0, "", "", {45, 35, 25, 15} // amount given in first stage based on gameskill level
	}, 
...
*/
	{
		"item_health_breadandmeat", "sound / pickup / health/cold_pickup.wav", {  "models/powerups/health/health_b3.md3", // just plate(should now be destructable)
 "models/powerups/health/health_b2.md3", // half eaten
 "models/powerups/health/health_b1.md3", // whole turkey
			0, 0}, "icons/iconh_breadandmeat", NULL, // ammo icon
		"Cold Meal", 10, // amount given in last stage
		IT_HEALTH, 0, 0, 0, "", "", {30, 30, 20, 15} // amount given in first stage based on gameskill level
	}, 
...
*/
	{
		"item_health_wall_box", "sound / pickup / health/health_pickup.wav", {  "models/powerups/health/health_wallbox2.md3", "models/powerups/health/health_wallbox1.md3", 0, 0, 0}, "icons/iconh_wall", NULL, // ammo icon
		"Health", 25, IT_HEALTH, 0, 0, 0, "", "", {25, 25, 25, 25}
	}, 
...
*/
	{
		"item_health_wall", "sound / pickup / health/health_pickup.wav", {  "models/powerups/health/health_w.md3", 0, 0, 0, 0}, "icons/iconh_wall", NULL, // ammo icon
		"Health", 25, IT_HEALTH, 0, 0, 0, "", "", {25, 25, 15, 15}
	},
	// STAMINA
...
*/
	...
	{
		"item_stamina_stein", "sound / pickup / health/stamina_pickup.wav", {  "models/powerups/instant / stamina_stein.md3", 0, 0, 0, 0}, "icons/icons_stein", NULL, // ammo icon
		"Stamina", 25, IT_POWERUP, PW_NOFATIGUE, 0, 0, "", "", {30, 25, 20, 15}
	}, 
...
*/
	...
	{
		"item_stamina_brandy", "sound / sound / pickup / health/stamina_pickup.wav", {  "models/powerups/instant / stamina_brandy2.md3", "models/powerups/instant / stamina_brandy1.md3", 0, 0, 0}, "icons/icons_brandy", NULL, // ammo icon
		"Stamina", 25, IT_POWERUP, PW_NOFATIGUE, 0, 0, "", "", {30, 25, 20, 15}
	}, 
...
*/
	{
		"item_armor_body", "sound / pickup / armor/body_pickup.wav", {  "models/powerups/armor/armor_body1.md3", 0, 0, 0, 0}, "icons/iconr_body", NULL, // ammo icon
		"Flak Jacket", 75, IT_ARMOR, 0, 0, 0, "", "", {75, 75, 75, 75}
	}, 
...
*/
	{
		"item_armor_body_hang", "sound / pickup / armor/body_pickup.wav", {  "models/powerups/armor/armor_body2.md3", 0, 0, 0, 0}, "icons/iconr_bodyh", NULL, // ammo icon
		"Flak Jacket", 75, IT_ARMOR, 0, 0, 0, "", "", {75, 75, 75, 75}
	}, 
...
*/
	{
		"item_armor_head", "sound / pickup / armor/head_pickup.wav", {  "models/powerups/armor/armor_head1.md3", 0, 0, 0, 0}, "icons/iconr_head", NULL, // ammo icon
		"Armored Helmet", 25, IT_ARMOR, 0, 0, 0, "", "", {25, 25, 25, 25}
	}, 
...
*/
	{
		"weapon_gauntlet", "sound/misc/w_pkup.wav", {  "models/weapons2/gauntlet / gauntlet.md3", 0, 0, 0, 0}, "", // icon
		"icons/ammo1", // ammo icon
		"Gauntlet", // pickup
		0, IT_WEAPON, WP_GAUNTLET, WP_GAUNTLET, WP_GAUNTLET, "",   // precache
		"",   // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_knife", "sound/misc/w_pkup.wav", {  "models/weapons2/knife / knife.md3", "models/weapons2/knife / v_knife.md3", "models/weapons2/knife / pu_knife.md3", 0, 0},
...
/*
	{
		"weapon_knife2", "sound/misc/w_pkup.wav", { "models/weapons2/knife2 / knife2.md3", "models/weapons2/knife2 / v_knife2.md3", "models/weapons2/knife2 / pu_knife2.md3", 0, 0},

		"icons/iconw_knife2_1", // icon
		"icons/ammo2", // ammo icon
		"Other Knife", // pickup
		50, IT_WEAPON, WP_KNIFE2, WP_KNIFE2, WP_KNIFE2, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"weapon_luger", "sound/misc/w_pkup.wav", {  "models/weapons2/luger / luger.md3", "models/weapons2/luger / v_luger.md3", "models/weapons2/luger / pu_luger.md3", 0, 0},
...
*/
	{
		"weapon_mauserRifle", "sound/misc/w_pkup.wav", {  "models/weapons2/mauser / mauser.md3", "models/weapons2/mauser / v_mauser.md3", "models/weapons2/mauser / pu_mauser.md3", 0, 0},

		"icons/iconw_mauser_1", // icon
		"icons/ammo3", // ammo icon
		"Mauser Rifle", // pickup
		50, IT_WEAPON, WP_MAUSER, WP_MAUSER, WP_MAUSER, "",   // precache
		"",   // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_thompson", "sound/misc/w_pkup.wav", {  "models/weapons2/thompson / thompson.md3", "models/weapons2/thompson / v_thompson.md3", "models/weapons2/thompson / pu_thompson.md3", 0, 0},

		"icons/iconw_thompson_1", // icon
		"icons/ammo2", // ammo icon
		"Thompson", // pickup
		30, IT_WEAPON, WP_THOMPSON, WP_COLT, WP_THOMPSON, "",  // precache
		"",  // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_sten", "sound/misc/w_pkup.wav", {  "models/weapons2/sten / sten.md3", "models/weapons2/sten / v_sten.md3", "models/weapons2/sten / pu_sten.md3", 0, 0}, "icons/iconw_sten_1", // icon
		"icons/ammo2", // ammo icon
		"Sten",  // pickup
		30, IT_WEAPON, WP_STEN, WP_LUGER, WP_STEN, "",  // precache
		"",  // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_akimbo", "sound/misc/w_pkup.wav", {  "models/weapons2/colt2 / colt2.md3", "models/weapons2/colt2 / v_colt2.md3", "models/weapons2/colt2 / pu_colt2.md3", 0, 0},

		"icons/iconw_colt_1", // icon
		"icons/ammo2", // ammo icon
		"Dual Colts", // pickup
		50, IT_WEAPON, WP_AKIMBO, WP_COLT, 
// 	WP_COLT, WP_AKIMBO, "",   // precache
		"",   // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_colt", "sound/misc/w_pkup.wav", {  "models/weapons2/colt / colt.md3", "models/weapons2/colt / v_colt.md3", "models/weapons2/colt / pu_colt.md3", 0, 0},
...
*/
	{
		"NOT_weapon_garandRifle", // modified so it can no longer be given individually
		"sound/misc/w_pkup.wav", {  "models/weapons2/garand / garand.md3", "models/weapons2/garand / v_garand.md3", "models/weapons2/garand / pu_garand.md3", 0, 0},

		"icons/iconw_garand_1", // icon
		"icons/ammo3", // ammo icon
		"",   // pickup			// modified so it can no longer be given individually
		50, IT_WEAPON, WP_GARAND, WP_GARAND, WP_GARAND, "",   // precache
		"",   // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_mp40", "sound/misc/w_pkup.wav", {  "models/weapons2/mp40 / mp40.md3", "models/weapons2/mp40 / v_mp40.md3", "models/weapons2/mp40 / pu_mp40.md3", 0, 0},

		"icons/iconw_mp40_1", // icon
		"icons/ammo2", // ammo icon
		"MP40", // pickup
		30, IT_WEAPON, WP_MP40, WP_LUGER, WP_MP40, "",  // precache
		"",  // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_fg42", "sound/misc/w_pkup.wav", {  "models/weapons2/fg42 / fg42.md3", "models/weapons2/fg42 / v_fg42.md3", "models/weapons2/fg42 / pu_fg42.md3", 0, 0},

		"icons/iconw_fg42_1", // icon
		"icons/ammo5", // ammo icon
		"FG42 Paratroop Rifle", // pickup
		10, IT_WEAPON, WP_FG42, WP_MAUSER, WP_FG42, "",  // precache
		"",  // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"weapon_bar", "sound/misc/w_pkup.wav", { "models/weapons2/bar / bar.md3", "models/weapons2/bar / v_bar.md3", "models/weapons2/bar / pu_bar.md3", 0, 0},

		"icons/iconw_bar_1", // icon
			"icons/ammo5", // ammo icon
		"BAR", // pickup
		10, IT_WEAPON, WP_BAR, WP_BAR, WP_BAR, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"weapon_bar2", "sound/misc/w_pkup.wav", { "models/weapons2/bar / bar.md3", "models/weapons2/bar / v_bar.md3", "models/weapons2/bar / pu_bar.md3", 0, 0},

		"icons/iconw_bar_1", // icon
			"icons/ammo5", // ammo icon
		"BAR", // pickup
		10, IT_WEAPON, WP_BAR2, WP_BAR, WP_BAR, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
// modified sp5 to be silencer mod for luger
/*QUAKED weapon_silencer(.3 .3 1)(-16 - 16 - 16)(16 16 16) SUSPENDED SPIN - RESPAWN
-------- MODEL FOR RADIANT ONLY - DO NOT SET THIS AS A KEY --------
model = "models/weapons2/sp5 / sp5.md3"
*/
	{
		"weapon_silencer", "sound/misc/w_pkup.wav", {  "models/weapons2/silencer / silencer.md3", // changed 10 / 25
 "models/weapons2/silencer / v_silencer.md3", "models/weapons2/silencer / pu_silencer.md3", 0, 0},
...
*/
	{
		"weapon_panzerfaust", "sound/misc/w_pkup.wav", {  "models/weapons2/panzerfaust / pf.md3", "models/weapons2/panzerfaust / v_pf.md3", "models/weapons2/panzerfaust / pu_pf.md3", 0, 0},
...
/*
	{
		"weapon_rocketlauncher", "sound/misc/w_pkup.wav", { "models/weapons2/rocketl / rocketl.md3", "models/weapons2/rocketl / v_rocketl.md3", "models/weapons2/rocketl / pu_rocketl.md3", 0, 0},

		"icons/iconw_rocket_1", // icon
		"icons/ammo6", // ammo icon
		"Bazooka", // pickup
		5, IT_WEAPON, WP_ROCKET_LAUNCHER, WP_ROCKET_LAUNCHER, WP_ROCKET_LAUNCHER, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"weapon_proxlauncher", "sound/misc/w_pkup.wav", { "models/weapons2/rocketl / rocketl.md3", "models/weapons2/rocketl / v_rocketl.md3", "models/weapons2/rocketl / pu_rocketl.md3", 0, 0},

		"icons/iconw_rocket_1", // icon
		"icons/ammo6", // ammo icon
		"Bazooka", // pickup
		5, IT_WEAPON, WP_PROX, WP_PROX, WP_PROX, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"weapon_grenadelauncher", "sound/misc/w_pkup.wav", {  "models/weapons2/grenade/grenade.md3", "models/weapons2/grenade/v_grenade.md3", "models/weapons2/grenade/pu_grenade.md3", 0, 0},
...
*/
	{
		"weapon_grenadepineapple", "sound/misc/w_pkup.wav", {  "models/weapons2/grenade/pineapple.md3", "models/weapons2/grenade/v_pineapple.md3", "models/weapons2/grenade/pu_pineapple.md3", 0, 0},
...
/*	// just commented out to remove the registration errors in SP(we register every weapon in every map in SP) {
		"weapon_grenadesmoke", "sound/misc/w_pkup.wav", { "models/multiplayer / smokegrenade/smokegrenade.md3", "models/multiplayer / smokegrenade/v_smokegrenade.md3", "models/multiplayer / smokegrenade/pu_smokegrenade.md3", 0, 0},

		"icons/iconw_smokegrenade_1", // icon
		"icons/ammo2", // ammo icon
		"smokeGrenade", // pickup
		50, IT_WEAPON, WP_GRENADE_SMOKE, WP_GRENADE_SMOKE, WP_GRENADE_SMOKE, "", // precache
		"sound/weapons/grenade/hgrenb1a.wav sound/weapons/grenade/hgrenb2a.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
/*	{
		"weapon_medic_heal", "sound/misc/w_pkup.wav", { "models/multiplayer / medpack / medpack.md3", "models/multiplayer / medpack / v_medpack.md3", "models/multiplayer / medpack / pu_medpack.md3", 0, 0},

		"icons/iconw_medheal_1", // icon
		"icons/ammo2", // ammo icon
		"Medic Heal", // pickup
		50, IT_WEAPON, WP_MEDIC_HEAL, WP_MEDIC_HEAL, WP_MEDIC_HEAL, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
// dhm
...
*/
	{
		"weapon_dynamite", "sound/misc/w_pkup.wav", {  "models/weapons2/dynamite / dynamite.md3", "models/weapons2/dynamite / v_dynamite.md3", "models/weapons2/dynamite / pu_dynamite.md3", 0, 0},

		"icons/iconw_dynamite_1", // icon
		"icons/ammo9", // ammo icon
		"Dynamite Weapon", // pickup
		7, IT_WEAPON, WP_DYNAMITE, WP_DYNAMITE, WP_DYNAMITE, "",   // precache
		"",   // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"weapon_dynamite2", "sound/misc/w_pkup.wav", { "models/weapons2/dynamite / dynamite.md3", "models/weapons2/dynamite / v_dynamite.md3", "models/weapons2/dynamite / pu_dynamite.md3", 0, 0},

		"icons/iconw_dynamite_1", // icon
		"icons/ammo9", // ammo icon
		"Dynamite Weapon", // pickup
		7, IT_WEAPON, WP_DYNAMITE2, WP_DYNAMITE, WP_DYNAMITE, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"weapon_venom", "sound/misc/w_pkup.wav", {  "models/weapons2/venom / venom.md3", "models/weapons2/venom / v_venom.md3", "models/weapons2/venom / pu_venom.md3", 0, 0},

		"icons/iconw_venom_1", // icon
		"icons/ammo8", // ammo icon
		"Venom", // pickup
		700, IT_WEAPON, WP_VENOM, WP_VENOM, WP_VENOM, "",   // precache
		"",   // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"weapon_venom_shotgun", "sound/misc/w_pkup.wav", { "models/weapons2/venom / venom.md3", "models/weapons2/venom / v_venom.md3", "models/weapons2/venom / pu_venom.md3", 0, 0},

		"icons/iconw_venom_1", // icon
		"icons/ammo8", // ammo icon
		"Venom Shotgun", // pickup
		700, IT_WEAPON, WP_VENOM_FULL, WP_VENOM, WP_VENOM_FULL, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"weapon_cross", "sound/misc/w_pkup.wav", { "models/weapons2/cross / cross.md3", "models/weapons2/cross / v_cross.md3", "models/weapons2/cross / pu_cross.md3", 0, 0},

		"icons/iconw_cross_1", // icon
		"icons/ammo9", // ammo icon
		"This dont exist", // pickup
		7, IT_WEAPON, WP_CROSS, WP_CROSS, WP_CROSS, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"weapon_flamethrower", "sound/misc/w_pkup.wav", {  "models/weapons2/flamethrower / flamethrower.md3", "models/weapons2/flamethrower / v_flamethrower.md3", "models/weapons2/flamethrower / pu_flamethrower.md3", 0, 0},
...
*/
	{
		"weapon_tesla", "sound/misc/w_pkup.wav",
		...
		"icons/ammo10", // ammo icon
		"Tesla Gun", // pickup
		200, IT_WEAPON, WP_TESLA, WP_TESLA, WP_TESLA, "",    // precache
		"",    // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"weapon_speargun", "sound/misc/w_pkup.wav", { "models/weapons2/speargun / speargun.md3", "models/weapons2/speargun / v_speargun.md3", "models/weapons2/speargun / pu_speargun.md3", 0, 0}, "icons/iconw_speargun_1", // icon
		"icons/ammo10", // ammo icon
		"Speargun", // pickup
		50, IT_WEAPON, WP_SPEARGUN, WP_SPEARGUN, WP_SPEARGUN, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, */
...
/*
	{
		"weapon_speargun_co2", "sound/misc/w_pkup.wav", { "models/weapons2/speargun / speargun.md3", "models/weapons2/speargun / v_speargun.md3", "models/weapons2/speargun / pu_speargun.md3", 0, 0},

		"icons/iconw_speargun_1", // icon
		"icons/ammo10", // ammo icon
		"CO2 Spears", // pickup
		50, IT_WEAPON, WP_SPEARGUN_CO2, WP_SPEARGUN_CO2, WP_SPEARGUN_CO2, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"weapon_sniperScope", "sound/misc/w_pkup.wav", {  "models/weapons2/mauser / mauser.md3", "models/weapons2/mauser / v_mauser.md3", 
//  "models/weapons2/mauser / v_mauser_scope.md3", "models/weapons2/mauser / pu_mauser_scope.md3", 0, 0}, 

// 	"icons/iconw_sniper_1", // icon
		"icons/iconw_mauser_1", // icon
		"icons/ammo10", // ammo icon
		"Sniper Scope", // pickup
		200, IT_WEAPON, WP_SNIPERRIFLE, WP_MAUSER, WP_MAUSER, "",    // precache
		"",    // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_snooperrifle", // modified
		"sound/misc/w_pkup.wav", {  "models/weapons2/garand / garand.md3", "models/weapons2/garand / v_garand.md3", "models/weapons2/garand / pu_garand.md3", 0, 0},

		"icons/iconw_garand_1", // icon
		"icons/ammo10", // ammo icon
		"Snooper Rifle", // pickup		// modified
		20, IT_WEAPON, WP_SNOOPERSCOPE, WP_GARAND, WP_GARAND, "",    // precache
		"",    // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_fg42scope", // modified
		"sound/misc/w_pkup.wav", {  "models/weapons2/fg42 / fg42.md3", "models/weapons2/fg42 / v_fg42.md3", "models/weapons2/fg42 / pu_fg42.md3", 0, 0},

		"icons/iconw_fg42_1", // icon
		"icons/ammo5",  // ammo icon
		"FG42 Scope",   // pickup		// modified
...
// need this for the scripting
/*
weapon_monster_attack1(.3 .3 1)(-16 - 16 - 16)(16 16 16) suspended
*/
	{
		"weapon_monster_attack1", "", {  "", "", 0, 0}, "", // icon
		NULL, // ammo icon
		"MonsterAttack1", // pickup
		100, IT_WEAPON, WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK1, // ammo
		WP_MONSTER_ATTACK1,
		"",    // precache
		"",    // sounds
		{0, 0, 0, 0}
...
*/
	{
		"weapon_monster_attack2", "", {  "", "", 0, 0}, "", // icon
		NULL, // ammo icon
		"MonsterAttack2", // pickup
		100, IT_WEAPON, WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK2, // ammo
		WP_MONSTER_ATTACK2,
		"",    // precache
		"",    // sounds
		{0, 0, 0, 0}
...
*/
	{
		"weapon_monster_attack3", "", {  "", "", 0, 0}, "", // icon
		NULL, // ammo icon
		"MonsterAttack3", // pickup
		100, IT_WEAPON, WP_MONSTER_ATTACK3, WP_MONSTER_ATTACK3, // ammo
		WP_MONSTER_ATTACK3, "",    // precache
		"",    // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_mortar", "sound/misc/w_pkup.wav", {  "models/weapons2/grenade/grenade.md3", "models/weapons2/grenade/v_grenade.md3", "models/weapons2/grenade/pu_grenade.md3", 0, 0}, "icons/iconw_grenade_1", // icon
		"icons/icona_grenade", // ammo icon
		"nopickup(WP_MORTAR)", // pickup
		6, IT_WEAPON, WP_MORTAR, WP_MORTAR, WP_MORTAR, "",   // precache
		"sound/weapons/mortar / mortarf1.wav", // sounds
		{0, 0, 0, 0}
	}, 


// class - specific multiplayer weapon, can't be picked up, dropped, or placed in map
/*
weapon_class_special(.3 .3 1)(-16 - 16 - 16)(16 16 16) suspended
*/
/*
	{
		"weapon_class_special", "sound/misc/w_pkup.wav", { "models/multiplayer / hammer / hammer.md3", "models/multiplayer / hammer / v_hammer.md3", "models/multiplayer / hammer / pu_hammer.md3", 0, 0,},

		"icons/iconw_hammer_1", // icon
		"icons/ammo2", // ammo icon
		"Special", // pickup
		50, // this should never be picked up
		IT_WEAPON, WP_CLASS_SPECIAL, WP_CLASS_SPECIAL, WP_CLASS_SPECIAL, "", // precache
		"", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"ammo_9mm_small", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am9mm_s.md3", 0, 0, 0, 0}, "icons/iconw_luger_1", // icon
		NULL,  // ammo icon
		"9mm Rounds", // pickup
		30, IT_AMMO, WP_LUGER, WP_LUGER, WP_LUGER, "",  // precache
		"",  // sounds
		{32, 24, 16, 16}
	}, 
...
*/
	{
		"ammo_9mm_large", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am9mm_l.md3", 0, 0, 0, 0}, "icons/iconw_luger_1", // icon
		NULL,  // ammo icon
		"9mm Box", // pickup
		100, IT_AMMO, WP_LUGER, WP_LUGER, WP_LUGER, "",  // precache
		"",  // sounds
		{96, 64, 48, 48}
	}, 
...
*/
	{
		"ammo_45cal_small", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am45cal_s.md3", 0, 0, 0, 0}, "icons/iconw_luger_1", // icon
		NULL,  // ammo icon
		".45cal Rounds", // pickup
		20, IT_AMMO, WP_COLT, WP_COLT, WP_COLT, "",  // precache
		"",  // sounds
		{30, 20, 15, 15}
	}, 
...
*/
	{
		"ammo_45cal_large", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am45cal_l.md3", 0, 0, 0, 0}, "icons/iconw_luger_1", // icon
		NULL,  // ammo icon
		".45cal Box", // pickup
		100, IT_AMMO, WP_COLT, WP_COLT, WP_COLT, "",  // precache
		"",  // sounds
		{90, 60, 45, 45}
	}, 
...
*/
	{
		"ammo_792mm_small", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am792mm_s.md3", 0, 0, 0, 0}, "icons/icona_machinegun", // icon
		NULL, // ammo icon
		"7.92mm Rounds", // pickup
		50, IT_AMMO, WP_MAUSER, WP_MAUSER, WP_MAUSER, "",    // precache
		"",    // sounds
		{16, 12, 8, 8}
	}, 
...
*/
	{
		"ammo_792mm_large", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am792mm_l.md3", 0, 0, 0, 0}, "icons/icona_machinegun", // icon
		NULL, // ammo icon
		"7.92mm Box",   // pickup
		50, IT_AMMO, WP_MAUSER, WP_MAUSER, WP_MAUSER, "",    // precache
		"",    // sounds
...
*/
	{
		"ammo_30cal_small", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am30cal_s.md3", 0, 0, 0, 0}, "icons/icona_machinegun", // icon
		NULL, // ammo icon
		".30cal Rounds", // pickup
...
*/
	{
		"ammo_30cal_large", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am30cal_l.md3", 0, 0, 0, 0}, "icons/icona_machinegun", // icon
		NULL, // ammo icon
		".30cal Box",   // pickup
		50, IT_AMMO, WP_GARAND, WP_GARAND, WP_GARAND, "",    // precache
		"",    // sounds
...
*/
	{
		"ammo_127mm", "sound/misc/am_pkup.wav", {"models/powerups/ammo / am127mm.md3", 0, 0, 0, 0}, "icons/icona_machinegun", // icon
		NULL, // ammo icon
		"12.7mm", // pickup
		100, IT_AMMO, WP_VENOM, WP_VENOM, WP_VENOM, "",    // precache
		"",    // sounds
		{100, 75, 50, 50}
	}, 
...
*/
	{
		"ammo_grenades", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amgren_bag.md3", 0, 0, 0, 0}, "icons/icona_grenade", // icon
		NULL,   // ammo icon
		"Grenades", // pickup
		5, IT_AMMO, WP_GRENADE_LAUNCHER, WP_GRENADE_LAUNCHER, WP_GRENADE_LAUNCHER, "",   // precache
		"",   // sounds
		{5, 4, 3, 3}
	}, 
...
*/
	{
		"ammo_grenades_american", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amgrenus_bag.md3", 0, 0, 0, 0}, "icons/icona_pineapple", // icon
		NULL,   // ammo icon
		"Pineapples", // pickup
		5, IT_AMMO, WP_GRENADE_PINEAPPLE, WP_GRENADE_PINEAPPLE, WP_GRENADE_PINEAPPLE, "",   // precache
		"",   // sounds
		{5, 4, 3, 3}
	}, 
...
*/
	{
		"ammo_dynamite", "sound/misc/am_pkup.wav", {"models/powerups/ammo / dynamite.md3", 0, 0, 0, 0}, "icons/icona_dynamite", // icon
		NULL,   // ammo icon
		"Dynamite", // pickup
...
*/
	{
		"ammo_cell", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amcell.md3", 0, 0, 0, 0}, "icons/icona_cell", // icon
		NULL,  // ammo icon
		"Cell", // pickup
		500, IT_AMMO, WP_TESLA, WP_TESLA, WP_TESLA, "",  // precache
		"",  // sounds
		{100, 75, 50, 50}
	}, 
...
*/
	{
		"ammo_fuel", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amfuel.md3", 0, 0, 0, 0}, "icons/icona_fuel", // icon
		NULL,  // ammo icon
		"Fuel", // pickup
		100, IT_AMMO, WP_FLAMETHROWER, WP_FLAMETHROWER, WP_FLAMETHROWER, "",  // precache
		"",  // sounds
		{100, 75, 50, 50}
	}, 
...
/*
	{
		"ammo_speargun", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amspear.md3", 0, 0, 0, 0}, "icons/icona_spear", // icon
		NULL, // ammo icon
		"Speargun Bolts", // pickup
		10, IT_AMMO, WP_SPEARGUN, WP_SPEARGUN, WP_SPEARGUN, "", // precache
		"", // sounds
		{100, 75, 50, 50}
	}, 
*/
...
/*
	{
		"ammo_speargun_co2", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amspear.md3", 0, 0, 0, 0}, "icons/icona_spear", // icon
		NULL, // ammo icon
		"C02 Speargun Bolts", // pickup
		10, IT_AMMO, WP_SPEARGUN_CO2, WP_SPEARGUN_CO2, WP_SPEARGUN_CO2, "", // precache
		"", // sounds
		{100, 75, 50, 50}
	}, 
*/
...
*/
	{
		"ammo_panzerfaust", "sound/misc/am_pkup.wav", {"models/powerups/ammo / ampf.md3", 0, 0, 0, 0}, "icons/icona_panzerfaust", // icon
		NULL,   // ammo icon
		"Panzerfaust Rockets",  // pickup
		5, IT_AMMO, WP_PANZERFAUST, WP_PANZERFAUST, WP_PANZERFAUST, "",   // precache
		"",   // sounds
		{4, 3, 2, 2}
	}, 
...
/*
	{
		"ammo_rockets", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amrocket.md3", 0, 0, 0, 0}, "icons/icona_rocket", // icon
		NULL, // ammo icon
		"Rockets", // pickup
		5, IT_AMMO, WP_ROCKET_LAUNCHER, WP_ROCKET_LAUNCHER, WP_ROCKET_LAUNCHER, "", // precache
		"", // sounds
		{4, 3, 2, 2}
	}, 
*/
...
/*
	{
		"ammo_charges", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amcharges.md3", 0, 0, 0, 0}, "icons/icona_charges", // icon
		NULL, // ammo icon
		"Charges", // pickup
		2, IT_AMMO, WP_CROSS, WP_CROSS, WP_CROSS, "", // precache
		"", // sounds
		{4, 2, 2, 1}
	}, 
*/
...
*/
	{
		"ammo_monster_attack1", "", {"", 0, 0, 0}, "",   // icon
		NULL,   // ammo icon
		"MonsterAttack1", // pickup
		60, IT_AMMO, WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK1, "", "", {0, 0, 0, 0}
	}, 
...
/*
	{
		"holdable_medkit", "sound / pickup / holdable / get_medkit.wav", {
 "models/powerups/holdable / medkit.md3", "models/powerups/holdable / medkit_sphere.md3", 0, 0, 0}, "icons/medkit", // icon
		NULL, // ammo icon
		"Medkit", // pickup
		1, IT_HOLDABLE, HI_MEDKIT, 0, 0, "", // precache
...
*/
	{
		"holdable_wine", "sound / pickup / holdable / get_wine.wav", {
 "models/powerups/holdable / wine.md3", 0, 0, 0, 0
		}, "icons/wine", // icon
		NULL,     // ammo icon
		"1921 Chateau Lafite", // pickup
		1, IT_HOLDABLE, HI_WINE, 0, 0, "",        // precache
...
/*
	{
		"holdable_skull", "sound / pickup / holdable / get_skull.wav", {
 "models/powerups/holdable / skull.md3", 0, 0, 0
		, 0}, "icons/skull", // icon
		NULL, // ammo icon
		"Skull of Invulnerability", // pickup
		1, IT_HOLDABLE, HI_SKULL, 0, 0, "", // precache
...
/*
	{
		"holdable_p_water", "sound / pickup / holdable / get_water.wav", {
 "models/powerups/holdable / water.md3", 0, 0, 0
		, 0}, "icons/water", // icon
		NULL, // ammo icon
		"Breather", // pickup
		1, IT_HOLDABLE, HI_WATER, 0, 0, "", // precache
...
/*
	{
		"holdable_p_elec", "sound / pickup / holdable / get_elec.wav", {
 "models/powerups/holdable / elec.md3", 0, 0, 0
		, 0}, "icons/elec", // icon
		NULL, // ammo icon
		"Electric Protection", // pickup
		1, IT_HOLDABLE, HI_ELECTRIC, 0, 0, "", // precache
...
/*
	{
		"holdable_p_fire", "sound / pickup / holdable / get_fire.wav", {
 "models/powerups/holdable / fire.md3", 0, 0, 0
		, 0}, "icons/fire", // icon
		NULL, // ammo icon
		"Fire Protection", // pickup
		1, IT_HOLDABLE, HI_FIRE, 0, 0, "", // precache
...
*/
	{
		"holdable_stamina", "sound / pickup / holdable / get_stamina.wav", {
 "models/powerups/holdable / stamina.md3", 0, 0, 0
			, 0
		}, "icons/stamina", // icon
		NULL,     // ammo icon
		"Added Stamina", // pickup
		1, IT_HOLDABLE, HI_STAMINA, 0, 0, "",        // precache
...
*/
	{
		"holdable_book1", "sound / pickup / holdable / get_book1.wav", {
 "models/powerups/holdable / venom_book.md3", 0, 0, 0
			, 0
		}, "icons/icon_vbook", // icon
		NULL, // ammo icon
		"Venom Tech Manual", // pickup
		1, IT_HOLDABLE, HI_BOOK1, 0, 0, "",        // precache
...
*/
	{
		"holdable_book2", "sound / pickup / holdable / get_book2.wav", {
 "models/powerups/holdable / paranormal_book.md3", 0, 0, 0
			, 0
		}, "icons/icon_pbook", // icon
		NULL,     // ammo icon
		"Project Book",  // pickup
		1, IT_HOLDABLE, HI_BOOK2, 0, 0, "",        // precache
		"sound / pickup / holdable / use_book.wav", // sounds
		{0, 0, 0, 0}
	}, 
...
*/
	{
		"holdable_book3", "sound / pickup / holdable / get_book3.wav", {
 "models/powerups/holdable / zemphr_book.md3", 0, 0, 0
			, 0
		}, "icons/icon_zbook", // icon
		NULL, // ammo icon
		"Dr. Zemph's Journal", // pickup
		1, IT_HOLDABLE, HI_BOOK3, 0, 0, "",        // precache
		"sound / pickup / holdable / use_book.wav", // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"holdable_11", "sound / pickup / holdable / get_11.wav", {
 "models/powerups/holdable / 11.md3", 0, 0, 0
		, 0}, "icons/11", // icon
		NULL, // ammo icon
		"11", // pickup
		1, IT_HOLDABLE, HI_11, 0, 0, "", // precache
...
/*
	{
		"holdable_12", "sound / pickup / holdable / get_12.wav", {
 "models/powerups/holdable / 12.md3", 0, 0, 0
		, 0}, "icons/12", // icon
		NULL, // ammo icon
		"12", // pickup
		1, IT_HOLDABLE, HI_12, 0, 0, "", // precache
...
/*
	{
		"holdable_13", "sound / pickup / holdable / get_13.wav", {
 "models/powerups/holdable / 13.md3", 0, 0, 0
		, 0}, "icons/13", // icon
		NULL, // ammo icon
		"13", // pickup
		1, IT_HOLDABLE, HI_13, 0, 0, "", // precache
...
/*
	{
		"holdable_14", "sound / pickup / holdable / get_14.wav", {
 "models/powerups/holdable / 14.md3", 0, 0, 0
		, 0}, "icons/14", // icon
		NULL, // ammo icon
		"14", // pickup
		1, IT_HOLDABLE, HI_14, 0, 0, "", // precache
...
/* holdable_15(.3 .3 1)(-8 - 8 - 8)(8 8 8) SUSPENDED SPIN - RESPAWN
 / 
	{
		"holdable_15", "sound / pickup / holdable / get_15.wav", {
 "models/powerups/holdable / 15.md3", 0, 0, 0
		, 0}, "icons/15", // icon
		NULL, // ammo icon
		"15", // pickup
		1, IT_HOLDABLE, HI_15, 0, "", // precache
...
*/
	{
		"team_CTF_redflag", "sound/teamplay/flagtk_red.wav", {"models/flags/r_flag.md3", 0, 0, 0, 0}, "icons/iconf_red", // icon
		NULL,  // ammo icon
		"Red Flag", // pickup
...
*/
	{
		"team_CTF_blueflag", "sound/teamplay/flagtk_blu.wav", {"models/flags/b_flag.md3", 0, 0, 0, 0}, "icons/iconf_blu", // icon
		NULL,  // ammo icon
		"Blue Flag", // pickup
...
/*
	{
		"key_skull1", "sound / pickup / keys / skull.wav", {
 "models/powerups/keys / skull.md3", 0, 0, 0
		, 0}, "icons/iconk_skull", // icon
		NULL, // ammo icon
		"Crystal Skull", // pickup
		0, IT_KEY, KEY_1, 0, 0, "", // precache
...
/*
	{
		"key_chalice2", "sound / pickup / keys / chalice.wav", {
 "models/powerups/keys / chalice.md3", 0, 0, 0
		, 0}, "icons/iconk_chalice", // icon
		NULL, // ammo icon
		"Chalice", // pickup
		0, IT_KEY, KEY_2, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_eye3", "sound / pickup / keys / eye.wav", {
 "models/powerups/keys / eye.md3", 0, 0, 0
		, 0}, "icons/iconk_eye", // icon
		NULL, // ammo icon
		"Eye of Isis", // pickup
		0, IT_KEY, KEY_3, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_radio4", "sound / pickup / keys / radio.wav", {
 "models/powerups/keys / radio_port.md3", 0, 0, 0
		, 0}, "icons/iconk_radio", // icon
		NULL, // ammo icon
		"Field Radio", // pickup
		0, IT_KEY, KEY_4, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_satchelcharge5", "sound / pickup / keys / satchelcharge.wav", {
 "models/powerups/keys / satchel_charge.md3", 0, 0, 0
		, 0}, "icons/iconk_satchel", // icon
		NULL, // ammo icon
		"Satchel Charge", // pickup
		0, IT_KEY, KEY_5, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
*/
	{
		"key_binocs", "sound / pickup / keys / binocs.wav", {
 "models/powerups/keys / binoculars.md3", 0, 0, 0
			, 0
		}, "icons/binocs", // icon
		NULL,   // ammo icon
		"Binoculars", // pickup
		0, IT_KEY, INV_BINOCS, 0, 0, "",   // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
...
/*
	{
		"key_key7", "sound / pickup / keys / key7.wav", {
 "models/powerups/keys / key7.md3", 0, 0, 0
		, 0}, "icons/key7", // icon
		NULL, // ammo icon
		"Key 7", // pickup
		0, IT_KEY, KEY_7, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key8", "sound / pickup / keys / key8.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key8", // icon
		NULL, // ammo icon
		"Key 8", // pickup
		0, IT_KEY, KEY_8, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key9", "sound / pickup / keys / key9.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key9", // icon
		NULL, // ammo icon
		"Key 9", // pickup
		0, IT_KEY, KEY_9, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key10", "sound / pickup / keys / key10.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key10", // icon
		NULL, // ammo icon
		"Key 10", // pickup
		0, IT_KEY, KEY_10, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key11", "sound / pickup / keys / key11.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key11", // icon
		NULL, // ammo icon
		"Key 11", // pickup
		0, IT_KEY, KEY_11, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key12", "sound / pickup / keys / key12.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key12", // icon
		NULL, // ammo icon
		"Key 12", // pickup
		0, IT_KEY, KEY_12, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key13", "sound / pickup / keys / key13.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key13", // icon
		NULL, // ammo icon
		"Key 13", // pickup
		0, IT_KEY, KEY_13, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key14", "sound / pickup / keys / key14.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key14", // icon
		NULL, // ammo icon
		"Key 14", // pickup
		0, IT_KEY, KEY_14, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key15", "sound / pickup / keys / key15.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key15", // icon
		NULL, // ammo icon
		"Key 15", // pickup
		0, IT_KEY, KEY_15, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
/*
	{
		"key_key16", "sound / pickup / keys / key16.wav", {
 "models/powerups/keys / key.md3", 0, 0, 0
		, 0}, "icons/key16", // icon
		NULL, // ammo icon
		"Key 16", // pickup
		0, IT_KEY, KEY_16, 0, 0, "", // precache
 "models/keys / key.wav", // sounds
		{0, 0, 0, 0}
	}, 
*/
...
gitem_t *BG_FindItemForPowerup(powerup_t pw) {
	...
	for (i = 0; i < bg_numItems; i++) {
		if ((bg_itemlist[i].giType == IT_POWERUP ||
			   bg_itemlist[i].giType == IT_TEAM) && bg_itemlist[i].giTag == pw) {
...
// check for mp
	...
	case IT_WEAPON:
		// medics & engineers can only pick up same weapon type
		if (multiplayer) {
...
char *eventnames[] = {
	"EV_NONE", "EV_FOOTSTEP", "EV_FOOTSTEP_METAL", "EV_FOOTSTEP_WOOD", "EV_FOOTSTEP_GRASS", "EV_FOOTSTEP_GRAVEL", "EV_FOOTSTEP_ROOF", "EV_FOOTSTEP_SNOW", "EV_FOOTSTEP_CARPET", "EV_FOOTSPLASH", "EV_FOOTWADE", "EV_SWIM", "EV_STEP_4", "EV_STEP_8", "EV_STEP_12", "EV_STEP_16", "EV_FALL_SHORT", "EV_FALL_MEDIUM", "EV_FALL_FAR", "EV_FALL_NDIE", "EV_FALL_DMG_10", "EV_FALL_DMG_15", "EV_FALL_DMG_25", "EV_FALL_DMG_50", "EV_JUMP_PAD", // boing sound at origin, jump sound on player
	...
	"EV_LOSE_HAT", "EV_GIB_HEAD", // only blow off the head
	...
	"EV_DEBUG_LINE", "EV_STOPLOOPINGSOUND", "EV_STOPSTREAMINGSOUND",
	"EV_TAUNT", "EV_SMOKE", "EV_SPARKS", "EV_SPARKS_ELECTRIC", "EV_BATS", "EV_BATS_UPDATEPOSITION", "EV_BATS_DEATH", "EV_EXPLODE", // func_explosive
