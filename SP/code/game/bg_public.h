...
typedef enum {
	CLDMG_SPIRIT, CLDMG_FLAMETHROWER, CLDMG_TESLA, CLDMG_BOSS1LIGHTNING, CLDMG_DEBRIS, CLDMG_MAX
} clientDamage_t;
...
// Rafael gameskill
typedef enum {
	GSKILL_EASY, GSKILL_MEDIUM, GSKILL_HARD, GSKILL_MAX     // must always be last
} gameskill_t;
...
typedef enum {
	...
	PERS_IMPRESSIVE_COUNT, PERS_EXCELLENT_COUNT, PERS_GAUNTLET_FRAG_COUNT, PERS_ACCURACY_SHOTS, PERS_ACCURACY_HITS, 
...
typedef enum {
	...
	AICHAR_SOLDIER, AICHAR_AMERICAN, AICHAR_ZOMBIE, AICHAR_WARZOMBIE, AICHAR_VENOM, AICHAR_LOPER, AICHAR_ELITEGUARD, AICHAR_STIMSOLDIER1, // dual machineguns
	AICHAR_STIMSOLDIER2, // rocket in left hand
	AICHAR_STIMSOLDIER3, // tesla in left hand
	AICHAR_SUPERSOLDIER, AICHAR_BLACKGUARD, AICHAR_PROTOSOLDIER,

	AICHAR_FROGMAN, AICHAR_HELGA, AICHAR_HEINRICH,

	AICHAR_PARTISAN, AICHAR_CIVILIAN,
...
// swapped mortar & antitank(unused?) and added class_special
...
// WP_PROX, // 32
	...
	WP_MEDIC_HEAL, // 29	// Medic special weapon
	WP_MORTAR, // 30
...
// means of death
typedef enum {
	MOD_UNKNOWN, MOD_SHOTGUN, MOD_GAUNTLET, MOD_MACHINEGUN, MOD_GRENADE, MOD_GRENADE_SPLASH, MOD_ROCKET, MOD_ROCKET_SPLASH, MOD_RAILGUN, MOD_LIGHTNING, MOD_BFG, MOD_BFG_SPLASH, MOD_KNIFE, MOD_KNIFE2, MOD_KNIFE_STEALTH, MOD_LUGER, MOD_COLT, MOD_MP40, MOD_THOMPSON, MOD_STEN, MOD_MAUSER, MOD_SNIPERRIFLE, MOD_GARAND, MOD_SNOOPERSCOPE, MOD_SILENCER, // ---- (SA)
	MOD_AKIMBO, // ---- (SA)
	MOD_BAR, // ---- (SA)
	MOD_FG42, MOD_FG42SCOPE, MOD_PANZERFAUST, MOD_ROCKET_LAUNCHER, MOD_GRENADE_LAUNCHER, MOD_VENOM, MOD_VENOM_FULL, MOD_FLAMETHROWER, MOD_TESLA, MOD_SPEARGUN, MOD_SPEARGUN_CO2, MOD_GRENADE_PINEAPPLE, MOD_CROSS, MOD_MORTAR, MOD_MORTAR_SPLASH, MOD_KICKED, MOD_GRABBER, MOD_DYNAMITE, MOD_DYNAMITE_SPLASH, MOD_AIRSTRIKE, // JPW NERVE
	MOD_WATER, MOD_SLIME, MOD_LAVA, MOD_CRUSH, MOD_TELEFRAG, MOD_FALLING, MOD_SUICIDE, MOD_TARGET_LASER, MOD_TRIGGER_HURT, MOD_GRAPPLE, MOD_EXPLOSIVE, MOD_POISONGAS, MOD_ZOMBIESPIT, MOD_ZOMBIESPIT_SPLASH, MOD_ZOMBIESPIRIT, MOD_ZOMBIESPIRIT_SPLASH, MOD_LOPER_LEAP, MOD_LOPER_GROUND, MOD_LOPER_HIT, 

// JPW NERVE multiplayer class - specific MODs
	MOD_LT_ARTILLERY, MOD_LT_AIRSTRIKE, MOD_ENGINEER, // not sure if we'll use
...
typedef enum {
	...
	HINT_PLAYER, HINT_ACTIVATE, HINT_NOACTIVATE, HINT_DOOR, HINT_DOOR_ROTATING, HINT_DOOR_LOCKED, HINT_DOOR_ROTATING_LOCKED, HINT_MG42, HINT_BREAKABLE, // 10
	HINT_BREAKABLE_DYNAMITE, HINT_CHAIR, HINT_ALARM, HINT_HEALTH, HINT_TREASURE, HINT_KNIFE, HINT_LADDER, HINT_BUTTON, HINT_WATER, HINT_CAUTION, // 20
	HINT_DANGER, HINT_SECRET, HINT_QUESTION, HINT_EXCLAMATION, HINT_CLIPBOARD, HINT_WEAPON, HINT_AMMO, HINT_ARMOR, HINT_POWERUP, HINT_HOLDABLE, // 30
	HINT_INVENTORY, HINT_SCENARIC, HINT_EXIT, HINT_NOEXIT, HINT_EXIT_FAR, HINT_NOEXIT_FAR, HINT_PLYR_FRIEND, HINT_PLYR_NEUTRAL, HINT_PLYR_ENEMY, HINT_PLYR_UNKNOWN, // 40
	HINT_BUILD,
...
typedef enum {
	GRENBOUNCE_DIRT, GRENBOUNCE_WOOD, GRENBOUNCE_METAL, GRENBOUNCE_DEFAULT, GRENBOUNCE_TOTAL
} grenbounde_t;
...
typedef enum {
	ANIM_MT_UNUSED, ANIM_MT_IDLE, ANIM_MT_IDLECR, ANIM_MT_WALK, ANIM_MT_WALKBK, ANIM_MT_WALKCR, ANIM_MT_WALKCRBK, ANIM_MT_RUN, ANIM_MT_RUNBK, ANIM_MT_SWIM, ANIM_MT_SWIMBK, ANIM_MT_STRAFERIGHT, ANIM_MT_STRAFELEFT, ANIM_MT_TURNRIGHT, ANIM_MT_TURNLEFT, ANIM_MT_CLIMBUP, ANIM_MT_CLIMBDOWN,
