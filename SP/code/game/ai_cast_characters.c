...
AICharacterDefaults_t aiDefaults[NUM_CHARACTERS] = {
	...
	// AICHAR_ZOMBIE
	{
		...
		}, AITEAM_MONSTER, "zombie / default", {/*WP_GAUNTLET, */ WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, BBOX_SMALL, {32, 48}, /*AIFL_NOPAIN|AIFL_WALKFORWARD|*/ AIFL_NO_RELOAD, AIFunc_ZombieFlameAttackStart, AIFunc_ZombieAttack2Start, AIFunc_ZombieMeleeStart, NULL, AISTATE_ALERT
	},
	// AICHAR_WARZOMBIE
	{
		"WarriorZombie", {
...
// 	"sound/weapons/melee / fstmiss.wav", // follow - go with ordering player("i'm with you" rather than "yes sir!")
			"sound/weapons/melee / warz_miss.wav", "warzombieOrdersDeny", // deny - refuse orders(doing something else)
		}, AITEAM_MONSTER, "warrior / crypt2", {WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, BBOX_SMALL, {10, 48}, // very low defense position
	...
	// AICHAR_VENOM
	{
		...
		}, AITEAM_NAZI, "venom / default", {WP_FLAMETHROWER}, BBOX_SMALL, {32, 48}, AIFL_NO_FLAME_DAMAGE|AIFL_WALKFORWARD|AIFL_NO_RELOAD, // |AIFL_NO_HEADSHOT_DMG, 0, 0, 0, NULL, AISTATE_RELAXED
	},
	// AICHAR_LOPER
	{
		"Loper", {
			...
			"loperHit2", // misc1
		}, AITEAM_MONSTER, "loper / default", {/*WP_MONSTER_ATTACK1, */ WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, BBOX_LARGE, {32, 32}, // large is for wide characters
		AIFL_NO_RELOAD, 0 /*AIFunc_LoperAttack1Start*/, AIFunc_LoperAttack2Start, AIFunc_LoperAttack3Start, "sound/world/electloop.wav", AISTATE_ALERT
	},
	// AICHAR_ELITEGUARD
	{
		"Elite Guard", {
	...
	// AICHAR_STIMSOLDIER2
	{
		"Stim Soldier", {
			...
			"stimSoldierFollow", // follow - go with ordering player("i'm with you" rather than "yes sir!")
			"stimSoldierOrdersDeny", // deny - refuse orders(doing something else)
		}, AITEAM_NAZI, "stim / default", {WP_MP40, WP_MONSTER_ATTACK1}, // attack1 is leaping rocket attack
...
// 	{WP_MP40, WP_GRENADE_LAUNCHER, WP_MONSTER_ATTACK1}, // attack1 is melee kick
		...
		BBOX_SMALL, {32, 48}, AIFL_CATCH_GRENADE|AIFL_FLIP_ANIM|AIFL_STAND_IDLE2, AIFunc_BlackGuardAttack1Start, 0, 0, NULL, AISTATE_RELAXED
	},
	// AICHAR_PROTOSOLDIER
	{
		"Protosoldier", {
		...
		}, AITEAM_NAZI, "protosoldier / default", {WP_VENOM}, BBOX_LARGE, {48, 64}, AIFL_NO_TESLA_DAMAGE|AIFL_NO_FLAME_DAMAGE|AIFL_WALKFORWARD|AIFL_NO_RELOAD, 0, 0, 0, NULL, AISTATE_ALERT
	},
	// AICHAR_FROGMAN
	{
		"Frogman", {
		...
		}, AITEAM_NAZI, "frogman / default", {0}, BBOX_SMALL, {32, 48}, // bbox, crouch / stand height
	...
	// AICHAR_HELGA
	{
		...
		AIFL_WALKFORWARD|AIFL_NO_RELOAD, AIFunc_Helga_MeleeStart, AIFunc_Helga_SpiritAttack_Start, 0,  // special attack routine
		NULL, AISTATE_ALERT
	},
	// AICHAR_HEINRICH
	{
		...
		}, AITEAM_NAZI, "heinrich / default", {WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, // attack3 is given to him by scripting
		BBOX_LARGE, {72, 72}, // (SA) height is not exact. just eyeballed.
		AIFL_NO_FLAME_DAMAGE|AIFL_WALKFORWARD|AIFL_NO_RELOAD, AIFunc_Heinrich_MeleeStart, AIFunc_Heinrich_RaiseDeadStart, AIFunc_Heinrich_SpawnSpiritsStart, NULL, AISTATE_ALERT
	},
	// AICHAR_PARTISAN
	{
		"Partisan", {
