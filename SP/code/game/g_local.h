...
struct gentity_s {
	...
	char *target;
	char *targetdeath;  // fire this on death exclusively 
	char *targetname;
	char *team;
...
extern vmCvar_t g_debugAudibleEvents;
extern vmCvar_t g_headshotMaxDist;
