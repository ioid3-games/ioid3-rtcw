...
keyname_t keynames_d[] =  // deutsch
{
	...
	{"SEMIKOLON", ';'}, // because a raw semicolon separates commands
...
keyname_t keynames_f[] =  // french
{
	...
	{"PN_VIRGULE", ';'}, // because a raw semicolon separates commands
...
keyname_t keynames_s[] = // Spanish
{
	...
	{"PAUSA", K_PAUSE},
	{"PUNTO_Y_COMA", ';'}, // because a raw semicolon separates commands
...
keyname_t keynames_i[] = // Italian
{
	...
	{"TN_=", K_KP_EQUALS},
	{"PAUSA", K_PAUSE},
	{"PUNTO_E_VIRGOLA", ';'}, // because a raw semicolon separates commands
