...
If pos is NULL, the sound will be dynamically sourced from the entity. Entchannel 0 will never override a playing sound.
...
If origin is NULL, the sound will be dynamically sourced from the entity. Entchannel 0 will never override a playing sound.
=======================================================================================================================================
*/
