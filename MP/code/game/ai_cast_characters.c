...
AICharacterDefaults_t aiDefaults[NUM_CHARACTERS] = {
	...
	}, // AICHAR_AMERICAN
	{
		"American", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "americanSightPlayer", "americanAttackPlayer", "americanOrders", "americanDeath", "americanDeath",
		...
		AITEAM_ALLIES, "american / default", {WP_THOMPSON, WP_GRENADE_PINEAPPLE}, BBOX_SMALL, {32, 48}, AIFL_CATCH_GRENADE|AIFL_STAND_IDLE2, 0, 0, 0, NULL, AISTATE_RELAXED
	}, // AICHAR_ZOMBIE
	{
		"Zombie", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "zombieSightPlayer", "zombieAttackPlayer", "zombieOrders", "zombieDeath", "zombieDeath",
		"zombiePain", "zombieStay", // stay - you're told to stay put
		...
		AITEAM_MONSTER, "zombie / default", {WP_GAUNTLET, WP_MONSTER_ATTACK2}, BBOX_SMALL, {32, 48}, /*AIFL_NOPAIN|*/ AIFL_WALKFORWARD|AIFL_NO_RELOAD, AIFunc_ZombieFlameAttackStart, AIFunc_ZombieAttack2Start, 0, NULL, AISTATE_ALERT
	}, 
	...
	// AICHAR_WARZOMBIE
	{
		"WarriorZombie", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "warzombieSightPlayer", "warzombieAttackPlayer", "warzombieOrders", "warzombieDeath", "warzombieDeath",
		"warzombiePain", "sound/weapons/melee / fstatck.wav", // stay - you're told to stay put
		...
		AITEAM_MONSTER, "warrior / default", {WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, BBOX_SMALL, {10, 48}, // very low defense position
		AIFL_NO_RELOAD, AIFunc_WarriorZombieMeleeStart, /*AIFunc_WarriorZombieSightStart*/ 0, AIFunc_WarriorZombieDefenseStart, NULL, AISTATE_ALERT
	},
	// AICHAR_FEMZOMBIE
	{
		"FemZombie", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "zombieFemSightPlayer", "zombieFemAttackPlayer", "zombieFemOrders", "zombieFemDeath", "zombieFemDeath",
		"zombieFemPain", "zombieFemStay", // stay - you're told to stay put
	...
	// AICHAR_UNDEAD
	{
		"Undead", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "undeadSightPlayer", "undeadAttackPlayer", "undeadOrders", "undeadDeath", "undeadDeath",
		"undeadPain", "undeadStay", // stay - you're told to stay put
		...
		AITEAM_MONSTER, "undead / default", {WP_GAUNTLET}, BBOX_SMALL, {32, 48}, AIFL_WALKFORWARD|AIFL_NO_RELOAD, 0, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_VENOM
	{
		"Venom", {
			110, // running speed
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "venomSightPlayer", "venomAttackPlayer", "venomOrders", "venomDeath", "venomDeath",
		...
		AITEAM_NAZI, "venom / default", {WP_VENOM, WP_VENOM_FULL, WP_FLAMETHROWER}, BBOX_SMALL, {32, 48}, AIFL_NO_FLAME_DAMAGE|AIFL_WALKFORWARD|AIFL_NO_RELOAD|AIFL_NO_HEADSHOT_DMG, 0, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_LOPER
	{
		"Loper", {
			220, // running speed
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "loperSightPlayer", "loperAttackPlayer", "loperOrders", "loperDeath", "loperDeath",
		"loperPain", "loperStay", // stay - you're told to stay put
		...
		AITEAM_MONSTER, "loper / default", {WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, BBOX_LARGE, {48, 48}, // large is for wide characters
		AIFL_NO_RELOAD, AIFunc_LoperAttack1Start, AIFunc_LoperAttack2Start, AIFunc_LoperAttack3Start, "sound/world/electloop.wav", AISTATE_ALERT
	}, // AICHAR_SEALOPER

	// no 'correct' values/weapons/etc. have been set. only adding character basics
	{
		"SeaLoper", {
			220, // running speed
			70, // walking speed
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "sealoperSightPlayer", "sealoperAttackPlayer", "sealoperOrders", "sealoperDeath", "sealoperDeath",
		"sealoperPain", "sealoperStay", // stay - you're told to stay put
		...
		AITEAM_MONSTER, "sealoper / default",

		{WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK2, WP_MONSTER_ATTACK3}, BBOX_LARGE, {48, 48}, // large is for wide characters
		AIFL_NO_RELOAD, AIFunc_LoperAttack1Start, AIFunc_LoperAttack2Start, AIFunc_LoperAttack3Start, "sound/world/electloop.wav", AISTATE_ALERT
	...
	// AICHAR_ELITEGUARD
	{
		"Elite Guard", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "eliteGuardSightPlayer", "eliteGuardAttackPlayer", "eliteGuardOrders", "eliteGuardDeath", "eliteGuardDeath",
		...
		BBOX_SMALL, {32, 48}, AIFL_CATCH_GRENADE|AIFL_STAND_IDLE2, 0, 0, 0, NULL, AISTATE_ALERT
	},
	// AICHAR_STIMSOLDIER1
	{
		"Stim Soldier", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "stimSoldierSightPlayer", "stimSoldierAttackPlayer", "stimSoldierOrders", "stimSoldierDeath", "stimSoldierDeath",
		...
		AITEAM_NAZI, "stim / default", {WP_MONSTER_ATTACK2}, // TODO: dual machinegun attack
		BBOX_LARGE, {48, 64}, AIFL_NO_RELOAD, 0, AIFunc_StimSoldierAttack2Start, 0, NULL, AISTATE_ALERT
	}, // AICHAR_STIMSOLDIER2
	{
		"Stim Soldier", {
			170, // running speed
		...
		"stimSoldierFollow", // follow - go with ordering player("i'm with you" rather than "yes sir!")
		"stimSoldierOrdersDeny", // deny - refuse orders(doing something else)
		AITEAM_NAZI, "stim / default", {WP_MP40, WP_ROCKET_LAUNCHER, WP_MONSTER_ATTACK1}, // attack1 is leaping rocket attack
		BBOX_LARGE, {48, 64}, AIFL_NO_RELOAD, AIFunc_StimSoldierAttack1Start, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_STIMSOLDIER3
	{
		"Stim Soldier", {
			170, // running speed
		...
		"stimSoldierFollow", // follow - go with ordering player("i'm with you" rather than "yes sir!")
		"stimSoldierOrdersDeny", // deny - refuse orders(doing something else)
		AITEAM_NAZI, "stim / default", {WP_MP40, WP_TESLA}, // no monster_attack1, since that's only used for the jumping rocket attack
		BBOX_LARGE, {48, 64}, AIFL_NO_RELOAD, AIFunc_StimSoldierAttack1Start, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_SUPERSOLDIER
	{
		"Super Soldier", {
		...
		}, "superSoldierSightPlayer", "superSoldierAttackPlayer", "superSoldierOrders", "superSoldierDeath", "superSoldierDeath",
		...
		AITEAM_NAZI, "supersoldier / default", {WP_VENOM}, BBOX_LARGE, {48, 64}, AIFL_NO_RELOAD|AIFL_NO_FLAME_DAMAGE|AIFL_NO_TESLA_DAMAGE, 0, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_BLACKGUARD
	{
		"Black Guard", {
			220, // running speed
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "blackGuardSightPlayer", "blackGuardAttackPlayer", "blackGuardOrders", "blackGuardDeath", "blackGuardDeath",
		...
		AITEAM_NAZI, "blackguard / default", 
// 	{WP_MP40, WP_GRENADE_LAUNCHER, WP_MONSTER_ATTACK1}, // attack1 is melee kick
		...
		BBOX_SMALL, {32, 48}, AIFL_CATCH_GRENADE|AIFL_FLIP_ANIM|AIFL_STAND_IDLE2, AIFunc_BlackGuardAttack1Start, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_PROTOSOLDIER
	{
		"Protosoldier", {
			170, // running speed
			...
			512, // relaxec detection radius
			2.0, // pain threshold multiplier
		}, "protoSoldierSightPlayer", "protoSoldierAttackPlayer", "protoSoldierOrders", "protoSoldierDeath", "protoSoldierDeath",
		...
		AITEAM_NAZI, "protosoldier / default", 
// 	{WP_TESLA}, {WP_VENOM_FULL}, BBOX_LARGE, {48, 64}, AIFL_NO_TESLA_DAMAGE|AIFL_NO_FLAME_DAMAGE|AIFL_WALKFORWARD|AIFL_NO_RELOAD, 0, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_REJECTX
	{
		"Reject X Creature", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "rejectXSightPlayer", "rejectXAttackPlayer", "rejectXOrders", "rejectXDeath", "rejectXDeath",
		"rejectXPain", "rejectXStay", "rejectXFollow", "rejectXOrdersDeny", AITEAM_NAZI, "rejectx / default", {WP_MONSTER_ATTACK1}, //, WP_FLAMETHROWER}, BBOX_SMALL, {32, 48}, AIFL_STAND_IDLE2|AIFL_NO_RELOAD, AIFunc_RejectAttack1Start, 0, 0, NULL, AISTATE_ALERT
	}, 
// AICHAR_FROGMAN
	{
		"Frogman", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "frogmanSightPlayer", "frogmanAttackPlayer", "frogmanOrders", "frogmanDeath", "frogmanDeath",
		...
		AITEAM_NAZI, "frogman / default", {WP_SPEARGUN}, BBOX_SMALL, {32, 48}, // bbox, crouch / stand height
		0, 0, 0, 0, NULL, AISTATE_RELAXED
	}, // AICHAR_HELGA
	{
		"Helga", {
			140, // running speed
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "helgaSightPlayer", "helgaAttackPlayer", "helgaOrders", "helgaDeath", "helgaDeath",
		"helgaPain", "helgaStay", // stay - you're told to stay put
...
// 	AIFL_STAND_IDLE2, // flags
		0, 0, 0, 0,   // special attack routine
		NULL, AISTATE_ALERT
	}, // AICHAR_HEINRICH
	{
		"Heinrich", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "heinrichSightPlayer", "heinrichAttackPlayer", "heinrichOrders", "heinrichDeath", "heinrichDeath", "heinrichPain", "heinrichStay", // stay - you're told to stay put
		...
		AITEAM_NAZI, "heinrich / default", {WP_VENOM_FULL}, BBOX_LARGE, {110, 140}, // (SA) height is not exact. just eyeballed.
		AIFL_WALKFORWARD|AIFL_NO_RELOAD, 0, 0, 0, NULL, AISTATE_ALERT
	}, // AICHAR_PARTISAN
	{
		"Partisan", {
			220, // running speed
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "partisanSightPlayer", "partisanAttackPlayer", "partisanOrders", "partisanDeath", "partisanDeath",
	...
	}, // AICHAR_CIVILIAN
	{
		"Civilian", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "civilianSightPlayer", "civilianAttackPlayer", "civilianOrders", "civilianDeath", "civilianDeath",
	...
	}, // AICHAR_CHIMP
	{
		"Chimp", {
			...
			512, // relaxec detection radius
			1.0, // pain threshold multiplier
		}, "chimpSightPlayer", "chimpAttackPlayer", "chimpOrders", "chimpDeath", "chimpDeath",
		"chimpPain", "chimpStay", "chimpFollow", "chimpOrdersDeny", AITEAM_ALLIES, // changed affiliation for DK
		"chimp / default", {0}, BBOX_SMALL, {16, 24}, AIFL_CATCH_GRENADE|AIFL_STAND_IDLE2|AIFL_NO_RELOAD, 0, 0, 0, NULL, AISTATE_ALERT
	},
};
//-------------------------------------------------------------------------- - 
...
int AIChar_GetPainLocation(gentity_t *ent, vec3_t point) {
	static char *painTagNames[] = {
		"tag_head", "tag_chest", "tag_torso", "tag_groin", "tag_armright", "tag_armleft", "tag_legright", "tag_legleft", NULL,};
...
void AIChar_spawn(gentity_t *ent) {
	...
	G_SoundIndex(aiDefaults[ent->aiCharacter].quietDeathSoundScript); 
