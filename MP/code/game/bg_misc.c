...
RTCW MP source code is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as
published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.

RTCW MP source code is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of
MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.

You should have received a copy of the GNU General Public License along with RTCW MP source code; if not,
see <http://www.gnu.org/licenses/>.

In addition, the RTCW MP source code is also subject to certain additional terms. You should have received a copy of these additional
terms immediately following the terms and conditions of the GNU General Public License which accompanied the RTCW MP source code.
...
int weapBanksMultiPlayer[MAX_WEAP_BANKS_MP][MAX_WEAPS_IN_BANK_MP] = {
	...
	{WP_KNIFE,  0, 0, 0, 0, 0,  0, 0         }, {WP_LUGER,  WP_COLT, 0, 0, 0, 0,  0, 0         }, {WP_MP40,   WP_THOMPSON, WP_STEN, WP_MAUSER, WP_GARAND, WP_PANZERFAUST, WP_VENOM, WP_FLAMETHROWER   }, {WP_GRENADE_LAUNCHER, WP_GRENADE_PINEAPPLE, 0, 0, 0, 0,  0, 0,}, {WP_MEDIC_SYRINGE, WP_PLIERS,  WP_SMOKE_GRENADE, 0, 0,  0, 0, 0,}, {WP_DYNAMITE, WP_MEDKIT,  WP_AMMO, 0, 0, 0,  0, 0         }
};
...
ammotable_t ammoTable[] = {
	...
	{  5,  1, 1, 1000, 750, 2000, 0, 0, MOD_PANZERFAUST       }, // WP_PANZERFAUST			// 7	// updated delay so prediction is correct
// {	MAX_AMMO_VENOM, 1, 500, 3000, 750, 30, 5000, 200, MOD_VENOM				}, // WP_VENOM				// - 
	{  MAX_AMMO_VENOM, 1, 500, 3000, 750, 45, 5000, 200, MOD_VENOM             }, // WP_VENOM				// 8	// JPW NOTE: changed next_shot 50->45 to genlock firing to every server frame(fire rate shouldn't be framerate dependent now) {  200, 1, 200, 1000, DELAY_LOW, 50, 0, 0, MOD_FLAMETHROWER      }, // WP_FLAMETHROWER			// 9 // JPW NOTE: changed maxclip for MP 500->150
...
// stubs for some "not - real" weapons(so they always return "yes, you have enough ammo for that gauntlet", etc.) {  5,  1, 5, 1000, DELAY_SHOULDER, 1200, 0, 0, 0 /*mod_prox*/        }, // WP_PROX					// 34
...
*/
	{
		"item_clipboard", "", {  "models/powerups/clipboard / clipboard.md3", 0, 0, 0, 0}, "icons/iconh_small", NULL,   // ammo icon
		"", 1, IT_CLIPBOARD, 0, 0, 0, "", "", {0, 0, 0, 0, 0}
	}, 
...
*/
	{
		"item_health_small", "sound/items/n_health.wav", {  "models/powerups/health/health_s.md3", 0, 0, 0, 0}, "icons/iconh_small", NULL, // ammo icon
		"Small Health", 5, IT_HEALTH, 0, 0, 0, "", "", {10, 5, 5, 5, 5}
	}, 
...
*/
	{
		"item_health", "sound / multiplayer / health_pickup.wav", // JPW NERVE also not single - binary friendly FIXME
		{  "models/multiplayer / medpack / medpack_pickup.md3", // JPW NERVE was "models/powerups/health/health_m.md3", 0,                        // FIXME this isn't single / multiplayer friendly if we go back to 1 codebase
			0, 0, 0}, "icons/iconh_med", NULL, // ammo icon
		"Med Health", 25, IT_HEALTH, 0, 0, 0, "", "", {50, 25, 20, 15, 15}
	}, 
...
*/
	{
		"item_health_large", "sound/items/n_health.wav", {  "models/powerups/health/health_l.md3", 0, 0, 0, 0}, "icons/iconh_large", NULL, // ammo icon
		"Large Health", 50, IT_HEALTH, 0, 0, 0, "", "", {100, 50, 50, 30, 30}
	}, 
...
*/
	{
		"item_health_turkey", "sound/items/n_health.wav", {  "models/powerups/health/health_t3.md3", // just plate(should now be destructable)
 ...
 "models/powerups/health/health_t1.md3", // whole turkey
		...
		IT_HEALTH, 0, 0, 0, "", "", {50, 50, 50, 40, 30}  // amount given in first stage based on gameskill level
	}, 
...
*/
	{
		"item_health_wall", "sound/items/n_health.wav", {  "models/powerups/health/health_w.md3", 0, 0, 0, 0}, "icons/iconh_wall", NULL, // ammo icon
...
*/
	{
		"item_stamina_stein", "sound/items/n_health.wav", {  "models/powerups/instant / stamina_stein.md3", 0, 0, 0, 0}, "icons/icons_wall", NULL, // ammo icon
		"Stamina", 25, IT_POWERUP, PW_NOFATIGUE, 0, 0, "", "", {25, 25, 25, 25, 25}
	}, 
...
*/
	{
		"item_stamina_brandy", "sound/items/n_health.wav", {  "models/powerups/instant / stamina_brandy2.md3", "models/powerups/instant / stamina_brandy1.md3", 0, 0, 0}, "icons/iconh_wall", NULL, // ammo icon
		"Stamina", 25, IT_POWERUP, PW_NOFATIGUE, 0, 0, "", "", {25, 25, 25, 25, 25}
	}, 
...
*/
	{
		...
		"Flak Jacket", 75, IT_ARMOR, 0, 0, 0, "", "", {75, 75, 75, 75, 75}
	}, 
...
*/
	{
		...
		"Armored Helmet", 25, IT_ARMOR, 0, 0, 0, "", "", {25, 25, 25, 25, 25}
	}, 
...
*/
	{
		"weapon_knife", "sound/misc/w_pkup.wav", {  "models/multiplayer / knife / knife.md3", "models/multiplayer / knife / v_knife.md3", 0, "models/multiplayer / knife / v_knife_axis.md3", 0},
...
*/
	{
		"weapon_knife2", "sound/misc/w_pkup.wav", {  "models/weapons2/knife2 / knife2.md3", "models/weapons2/knife2 / v_knife2.md3", 0, 0, 0},
...
*/
	{
		"weapon_luger", "sound/misc/w_pkup.wav", {  "models/weapons2/luger / luger.md3", "models/weapons2/luger / v_luger.md3", 0, 0, "models/weapons2/luger / ss_luger.md3"},
...
*/
	{
		"weapon_mauserRifle", "sound/misc/w_pkup.wav", {  "models/weapons2/mauser / mauser.md3", "models/weapons2/mauser / v_mauser.md3", "models/multiplayer / mauser / mauser_pickup.md3", "models/multiplayer / mauser / v_mauser_axis.md3", "models/weapons2/mauser / ss_mauser.md3"},
...
*/
	{
		"weapon_thompson", "sound/misc/w_pkup.wav", {  "models/weapons2/thompson / thompson.md3", "models/weapons2/thompson / v_thompson.md3", 0, "models/multiplayer / thompson / v_thompson_barrel3_axis.md3", "models/weapons2/thompson / ss_thompson.md3"},
...
*/
	{
		"weapon_sten", "sound/misc/w_pkup.wav", {  "models/weapons2/sten / sten.md3", "models/weapons2/sten / v_sten.md3", 0, 0, "models/weapons2/sten / ss_sten.md3"}, "icons/iconw_sten_1", // icon
		"icons/ammo2", // ammo icon
		"Sten",  // pickup
...
*/
	{
		"weapon_colt", "sound/misc/w_pkup.wav", {  "models/weapons2/colt / colt.md3", "models/weapons2/colt / v_colt.md3", 0, 0, "models/weapons2/colt / ss_colt.md3"},
...
*/
	{
		"weapon_mp40", "sound/misc/w_pkup.wav", {  "models/weapons2/mp40 / mp40.md3", "models/weapons2/mp40 / v_mp40.md3", 0, "models/multiplayer / mp40 / v_mp40_barrel3_axis.md3", "models/weapons2/mp40 / ss_mp40.md3"},
...
*/
	{
		"weapon_panzerfaust", "sound/misc/w_pkup.wav", {  "models/weapons2/panzerfaust / pf.md3", "models/weapons2/panzerfaust / v_pf.md3", 0, 0, "models/weapons2/panzerfaust / ss_pf.md3"},
...
*/
	{
		"weapon_grenadelauncher", "sound/misc/w_pkup.wav", {  "models/weapons2/grenade/grenade.md3", "models/weapons2/grenade/v_grenade.md3", 0, 0, "models/weapons2/grenade/ss_grenade.md3"},
...
*/
	{
		"weapon_grenadepineapple", "sound/misc/w_pkup.wav", {  "models/weapons2/grenade/pineapple.md3", "models/weapons2/grenade/v_pineapple.md3", 0, 0, "models/weapons2/grenade/ss_pineapple.md3"},
...
*/
	{
		"weapon_grenadesmoke", "sound/misc/w_pkup.wav", {  "models/multiplayer / smokegrenade/smokegrenade.md3", "models/multiplayer / smokegrenade/v_smokegrenade.md3", 0, 0, 0},

		"icons/iconw_smokegrenade_1", // icon
		"icons/ammo2", // ammo icon
		"smokeGrenade", // pickup
		50, IT_WEAPON, WP_SMOKE_GRENADE, WP_SMOKE_GRENADE, WP_SMOKE_GRENADE, "",   // precache
		"sound/weapons/grenade/hgrenb1a.wav sound/weapons/grenade/hgrenb2a.wav", // sounds
		{0, 0, 0, 0, 0}
	}, 
...
*/
	{
		"weapon_smoketrail", "sound/misc/w_pkup.wav", {  "models/multiplayer / smokegrenade/smokegrenade.md3", "models/multiplayer / smokegrenade/v_smokegrenade.md3", 0, 0, 0},
...
*/
	{
		"weapon_medic_heal", "sound/misc/w_pkup.wav", {  "models/multiplayer / medpack / medpack.md3", "models/multiplayer / medpack / v_medpack.md3", 0, 0, 0},
...
*/
	{
		"weapon_dynamite2", "sound/misc/w_pkup.wav", {  "models/weapons2/dynamite / dynamite.md3", "models/weapons2/dynamite / v_dynamite.md3", 0, 0, 0},
...
*/
	{
		"weapon_venom", "sound/misc/w_pkup.wav", {  "models/weapons2/venom / venom.md3", "models/weapons2/venom / v_venom.md3", "models/weapons2/venom / pu_venom.md3", 0, "models/weapons2/venom / ss_venom.md3"},
...
*/
	{
		"weapon_flamethrower", "sound/misc/w_pkup.wav", {  "models/weapons2/flamethrower / flamethrower.md3", "models/weapons2/flamethrower / v_flamethrower.md3", "models/weapons2/flamethrower / pu_flamethrower.md3", 0, "models/weapons2/flamethrower / ss_flamethrower.md3"},
...
//  "models/weapons2/mauser / v_mauser_scope.md3", "models/multiplayer / mauser / mauser_pickup.md3", 0, "models/weapons2/mauser / ss_mauser.md3"}, 
...
*/
	{
		"weapon_mortar", "sound/misc/w_pkup.wav", {  "models/weapons2/grenade/grenade.md3", "models/weapons2/grenade/v_grenade.md3", 0, 0}, "icons/iconw_grenade_1", // icon
		"icons/icona_grenade", // ammo icon
...
*/
	{
		"weapon_class_special", "sound/misc/w_pkup.wav", {  "models/multiplayer / pliers / pliers.md3", "models/multiplayer / pliers / v_pliers.md3", 0, "models/multiplayer / pliers / v_pliers_axis.md3", ""},
...
*/
	{
		"weapon_arty", "sound/misc/w_pkup.wav", {  "models/multiplayer / syringe / syringe.md3", "models/multiplayer / syringe / v_syringe.md3", 0, 0, ""},
...
*/
	{
		"weapon_medic_syringe", "sound/misc/w_pkup.wav", {  "models/multiplayer / syringe / syringe.md3", "models/multiplayer / syringe / v_syringe.md3", 0, "models/multiplayer / syringe / v_syringe_axis.md3", ""},
...
*/
	{
		"weapon_magicammo", "sound/misc/w_pkup.wav", {  "models/multiplayer / ammopack / ammopack.md3", "models/multiplayer / ammopack / v_ammopack.md3", "models/multiplayer / ammopack / ammopack_pickup.md3", 0, ""},
...
*/
	{
		"weapon_binoculars", "sound/misc/w_pkup.wav", {  "", "", "", 0, ""},
...
*/
	{
		"ammo_grenades_american", "sound/misc/am_pkup.wav", {"models/powerups/ammo / amgren_bag.md3", 0, 0, 0, 0}, "icons/icona_pineapple", // icon
		NULL,   // ammo icon
		"Pineapples", // pickup
...
*/
	{
		"ammo_dynamite", "sound/misc/am_pkup.wav", {"models/multiplayer / dynamite / dynamite.md3", 0, 0, 0, 0}, "icons/icona_dynamite", // icon
		NULL,   // ammo icon
		"Dynamite", // pickup
...
*/
	{
		...
		60, IT_AMMO, WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK1, WP_MONSTER_ATTACK1, "", "", {0, 0, 0, 0, 0}
	}, 
...
*/
 ...
 "models/powerups/holdable / medkit.md3", "models/powerups/holdable / medkit_sphere.md3", 0, 0, 0
		}, "icons/medkit", // icon
		NULL, // ammo icon
		"Medkit", // pickup
...
*/
	{
		"team_CTF_redflag", "", {"models/multiplayer / treasure / treasure.md3", 0, 0, 0, 0}, "icons/iconf_red", // icon
		NULL,  // ammo icon
		"Objective", // pickup
...
*/
	{
		"team_CTF_blueflag", "", {"models/multiplayer / treasure / treasure.md3", 0, 0, 0, 0}, "icons/iconf_blu", // icon
		NULL,  // ammo icon
		"Blue Flag", // pickup
...
*/
	{
		"key_goldbar", "sound / pickup / keys / goldbar.wav", {
 "models/powerups/keys / goldbar.md3", 0, 0, 0
			, 0
		}, "icons/key7", // icon
		NULL,   // ammo icon
		"Gold Bars", // pickup
...
char *eventnames[] = {
	...
	"EV_NOITEM", "EV_NOAMMO", "EV_EMPTYCLIP", "EV_FILL_CLIP", "EV_MG42_FIXED", // JPW NERVE
	"EV_WEAP_OVERHEAT", "EV_CHANGE_WEAPON", "EV_FIRE_WEAPON", "EV_FIRE_WEAPONB", "EV_FIRE_WEAPON_LASTSHOT", "EV_FIRE_QUICKGREN", // "Quickgrenade"
	"EV_NOFIRE_UNDERWATER", "EV_FIRE_WEAPON_MG42", "EV_USE_ITEM0", "EV_USE_ITEM1", "EV_USE_ITEM2", "EV_USE_ITEM3", "EV_USE_ITEM4", "EV_USE_ITEM5", "EV_USE_ITEM6", "EV_USE_ITEM7", "EV_USE_ITEM8", "EV_USE_ITEM9", "EV_USE_ITEM10", "EV_USE_ITEM11", "EV_USE_ITEM12", "EV_USE_ITEM13", "EV_USE_ITEM14", "EV_USE_ITEM15", "EV_ITEM_RESPAWN", "EV_ITEM_POP", "EV_PLAYER_TELEPORT_IN", "EV_PLAYER_TELEPORT_OUT", "EV_GRENADE_BOUNCE", // eventParm will be the soundindex
	...
	"EV_PAIN", "EV_CROUCH_PAIN", "EV_DEATH1", "EV_DEATH2", "EV_DEATH3", "EV_OBITUARY", "EV_STOPSTREAMINGSOUND", // JPW NERVE swiped from Sherman
	"EV_POWERUP_QUAD", "EV_POWERUP_BATTLESUIT", "EV_POWERUP_REGEN", "EV_GIB_PLAYER", // gib a previously living player
	"EV_DEBUG_LINE", "EV_STOPLOOPINGSOUND", "EV_TAUNT", "EV_SMOKE", "EV_SPARKS", "EV_SPARKS_ELECTRIC", "EV_BATS", "EV_BATS_UPDATEPOSITION", "EV_BATS_DEATH", "EV_EXPLODE", // func_explosive
