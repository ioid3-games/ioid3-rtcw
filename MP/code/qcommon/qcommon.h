...
// increased this, seems to keep causing problems when set to 64, especially when loading
...
typedef enum {
	...
	NA_BOT, NA_LOOPBACK, NA_BROADCAST, NA_IP, NA_IP6, NA_MULTICAST6, NA_UNSPEC
} netadrtype_t;
...
enum clc_ops_e {
	clc_bad, clc_nop, clc_move,  // [[usercmd_t]
