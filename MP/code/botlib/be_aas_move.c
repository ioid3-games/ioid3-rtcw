...
int AAS_AgainstLadder(vec3_t origin, int ms_areanum) {
	...
	// it does if they're in a monsterclip brush
	if (!areanum) {
		areanum = ms_areanum;
	}
...
=======================================================================================================================================
*/
int AAS_ClientMovementPrediction(struct aas_clientmove_s *move, int entnum, vec3_t origin, int presencetype, int onground, vec3_t velocity, vec3_t cmdmove, int cmdframes, int maxframes, float frametime, int stopevent, int stopareanum, int visualize) {
