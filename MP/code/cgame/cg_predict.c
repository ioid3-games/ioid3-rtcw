...
// JPW NERVE
		if (ent->eType == ET_CONCUSSIVE_TRIGGER) {
			...
			CG_Printf("cmodel=%d mins=%f, %f, %f maxs=%f, %f, %f\n", cmodel, mins[0], mins[1], mins[2], maxs[0], maxs[1], maxs[2]);

			CG_AddDirtBulletParticles(mins, dir, 190, // speed
									900, // duration
									1, // count
									0.25, 32, 32, 0.5, "dirt_splash");	// rand scale
			CG_AddDirtBulletParticles(maxs, dir, 190, // speed
									900, // duration
									1, // count
									0.25, 32, 32, 0.5, "dirt_splash");	// rand scale
		} else
