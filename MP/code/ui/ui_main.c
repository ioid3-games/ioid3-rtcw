...
static const char *teamArenaGameTypes[] = {
	"FFA", "TOURNAMENT", "SP", "TEAM DM", "CTF", "WOLF MP",  // NERVE - SMF
	"WOLF SW",  // NERVE - SMF
	"WOLF CP"              // NERVE - SMF
};
...
static weaponType_t weaponTypes[] = {
	...
	{WP_COLT, "1911 pistol", PT_PISTOL, "mp_weapon", 0, "ui_mp / assets/weapon_colt1911.tga", "firing_pistolB_1", "stand_pistolB", ""}, {WP_LUGER, "Luger pistol", PT_PISTOL, "mp_weapon", 1, "ui_mp / assets/weapon_luger.tga", "firing_pistolB_1", "stand_pistolB", ""},
	{WP_MP40,  "MP 40",  PT_LIGHTONLY|PT_RIFLE, "mp_weapon", 3, "ui_mp / assets/weapon_mp40.tga", "relaxed_idle_2h_1", "relaxed_idle_2h_1", "limbo_mp40"}, {WP_THOMPSON, "Thompson",   PT_LIGHTONLY|PT_RIFLE, "mp_weapon", 4, "ui_mp / assets/weapon_thompson.tga", "relaxed_idle_2h_1", "relaxed_idle_2h_1", "limbo_thompson"}, {WP_STEN,  "Sten", PT_LIGHTONLY|PT_RIFLE, "mp_weapon", 5, "ui_mp / assets/weapon_sten.tga", "relaxed_idle_2h_1", "relaxed_idle_2h_1", "limbo_sten"},
	{WP_MAUSER, "Mauser",  PT_RIFLE, "mp_weapon", 6, "ui_mp / assets/weapon_mauser.tga", "stand_rifle", "stand_rifle", "limbo_mauser"}, {WP_PANZERFAUST, "Panzerfaust",   PT_RIFLE, "mp_weapon", 8, "ui_mp / assets/weapon_panzerfaust.tga", "stand_panzer", "stand_panzer", "limbo_panzer"}, {WP_VENOM, "Venom",  PT_RIFLE, "mp_weapon", 9, "ui_mp / assets/weapon_venom.tga", "stand_machinegun", "stand_machinegun", "limbo_venom"}, {WP_FLAMETHROWER, "Flamethrower",  PT_RIFLE, "mp_weapon", 10, "ui_mp / assets/weapon_flamethrower.tga", "stand_machinegun", "stand_machinegun", "limbo_flame"},
	{WP_GRENADE_PINEAPPLE, "Pineapple grenade", PT_GRENADES, "mp_item1", 11, "ui_mp / assets/weapon_grenade.tga", "firing_pistolB_1", "stand_pistolB", ""}, {WP_GRENADE_LAUNCHER, "Stick grenade", PT_GRENADES, "mp_item1", 12, "ui_mp / assets/weapon_grenade_ger.tga", "firing_pistolB_1", "stand_pistolB", ""},
...
static uiitemType_t itemTypes[] = {
	{UI_KNIFE_PIC, PT_KNIFE, "ui_mp / assets/weapon_knife.tga"}, {UI_PISTOL_PIC, PT_PISTOL, "ui_mp / assets/weapon_colt1911.tga"},
	{UI_WEAPON_PIC, PT_RIFLE, "ui_mp / assets/weapon_mauser.tga"},
	{UI_ITEM1_PIC, PT_MEDKIT, "ui_mp / assets/item_medkit.tga"},
	{UI_ITEM1_PIC, PT_GRENADES, "ui_mp / assets/weapon_grenade.tga"}, {UI_ITEM2_PIC, PT_EXPLOSIVES, "ui_mp / assets/weapon_dynamite.tga"},
	{NULL, 0, NULL}
};
		...
		case UIMENU_MAIN:
			...
			if ((strlen(buf)) && (Q_stricmp(buf, ";"))) {
				...
				if (UI_Cvar_VariableString("com_errorDiagnoseIP")[0]) {
					...
					if (missing_files[0]) {
						trap_Cvar_Set("com_errorMessage", va("%s\n\n%s\n%s", UI_Cvar_VariableString("com_errorMessage"), UI_TranslateString(MISSING_FILES_MSG), missing_files));
					}
				}
...
void UI_DrawConnectScreen(qboolean overlay) {
	...
	// This now accepts strings up to 256 chars long, and will break them up into multiple lines.
...
cvarTable_t cvarTable[] = {
	...
	{&ui_userAxisRespawnTime, "ui_userAxisRespawnTime", "0", 0}, // - NERVE - SMF
...
// JPW NERVE
	...
	{&ui_marks, "cg_marktime", "20000", CVAR_ARCHIVE}, // JOSEPH 12 - 2 - 99
	{&ui_autoactivate, "cg_autoactivate", "1", CVAR_ARCHIVE}, // END JOSEPH
	...
	{&ui_isSpectator, "ui_isSpectator", "1", 0}, // - NERVE - SMF
